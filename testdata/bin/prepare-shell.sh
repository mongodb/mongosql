...
BUILD_FLAGS="$BUILD_RACE_FLAG $BIN_TYPE_FLAG"
...
SQLPROXY_SCHEMA_ARGS="$SQLPROXY_SCHEMA_SOURCE $SQLPROXY_SCHEMA_ALTER $SQLPROXY_SAMPLE_SIZE $SQLPROXY_SCHEMA_MODE $SQLPROXY_SAMPLE_INTERVAL $SQLPROXY_SAMPLE_NAMESPACES $SQLPROXY_SAMPLE_PREJOIN"
SQLPROXY_DEBUG_ARGS="$SQLPROXY_PROFILE"
SQLPROXY_SERVER_ARGS="$SQLPROXY_ADDR"
SQLPROXY_AUTH_ARGS="$SQLPROXY_AUTH_MECHANISM $SQLPROXY_AUTH $SQLPROXY_ADMIN_CREDS $SQLPROXY_ADMIN_AUTH_SOURCE $SQLPROXY_GSSAPI_HOST_NAME_ARG $SQLPROXY_GSSAPI_SERVICE_NAME_ARG $SQLPROXY_MONGO_GSSAPI_SERVICE_NAME_ARG"
SQLPROXY_ARGS="$SQLPROXY_AUTH_ARGS $SQLPROXY_SSL_ARGS $SQLPROXY_MONGO_SSL_ARGS $SQLPROXY_MONGO_URI_ARGS $SQLPROXY_LOG_ARGS $SQLPROXY_SCHEMA_ARGS $SQLPROXY_DEBUG_ARGS $SQLPROXY_SERVER_ARGS $SQLPROXY_SCHEMA_MAPPING_MODE_ARGS"
