...
SQLPROXY_SCHEMA_ARGS="$SQLPROXY_SCHEMA_SOURCE $SQLPROXY_SCHEMA_ALTER $SQLPROXY_SAMPLE_SIZE $SQLPROXY_SAMPLE_MODE $SQLPROXY_SAMPLE_INTERVAL"
SQLPROXY_DEBUG_ARGS="$SQLPROXY_PROFILE"
SQLPROXY_SERVER_ARGS="$SQLPROXY_ADDR"
SQLPROXY_AUTH_ARGS="$SQLPROXY_AUTH $SQLPROXY_ADMIN_CREDS $SQLPROXY_ADMIN_AUTH_SOURCE $SQLPROXY_GSSAPI_SERVICE_NAME_ARG"
SQLPROXY_ARGS="$SQLPROXY_AUTH_ARGS $SQLPROXY_SSL_ARGS $SQLPROXY_MONGO_SSL_ARGS $SQLPROXY_MONGO_URI_ARGS $SQLPROXY_SCHEMA_ARGS $SQLPROXY_LOG_ARGS $SQLPROXY_SCHEMA_ARGS $SQLPROXY_DEBUG_ARGS $SQLPROXY_SERVER_ARGS"
