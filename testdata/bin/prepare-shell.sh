...
SQLPROXY_ARGS="$SQLPROXY_AUTH_ARGS $SQLPROXY_SSL_ARGS $SQLPROXY_MONGO_SSL_ARGS $SQLPROXY_MONGO_URI_ARGS $SQLPROXY_SCHEMA_ARGS $SQLPROXY_LOG_ARGS $SQLPROXY_SCHEMA_ARGS $SQLPROXY_DEBUG_ARGS"
