...
SQLPROXY_SCHEMA_ARGS="$SQLPROXY_SCHEMA_SOURCE $SQLPROXY_SAMPLE_SIZE $SQLPROXY_SAMPLE_CREDS $SQLPROXY_SAMPLE_AUTH_SOURCE $SQLPROXY_SAMPLE_MODE $SQLPROXY_SAMPLE_INTERVAL"
SQLPROXY_ARGS="$SQLPROXY_AUTH_ARGS $SQLPROXY_SSL_ARGS $SQLPROXY_MONGO_SSL_ARGS $SQLPROXY_SCHEMA_ARGS $SQLPROXY_LOG_ARGS $SQLPROXY_SCHEMA_ARGS"
