...
test-cleartext-auth-nossl: INFRASTRUCTURE_CONFIG = default,mongo/auth,sqlproxy/auth,sqlproxy/ssl/disabled,client/auth/creds
...
test-cleartext-auth-allowssl-nossl: INFRASTRUCTURE_CONFIG = default,mongo/auth,sqlproxy/auth,sqlproxy/ssl/allow,sqlproxy/ssl/pem,client/auth/creds
...
test-cleartext-auth-ssl: INFRASTRUCTURE_CONFIG = default,mongo/auth,sqlproxy/auth,sqlproxy/ssl/allow,sqlproxy/ssl/pem,client/auth/creds,client/auth/cleartext,client/ssl/require
test-cleartext-auth-ssl: test-connect-success

# reject cleartext auth attempt with incorrect credentials
test-cleartext-auth-wrong-creds: INFRASTRUCTURE_CONFIG = default,mongo/auth,sqlproxy/auth,sqlproxy/ssl/allow,sqlproxy/ssl/pem,client/auth/cleartext,client/ssl/require
