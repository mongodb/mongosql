...
test-cleartext-auth-nossl: INFRASTRUCTURE_CONFIG := $(INFRASTRUCTURE_CONFIG),mongo/auth,sqlproxy/auth,sqlproxy/ssl/disabled,client/auth/creds,client/auth/cleartext,client/ssl/disable
...
test-cleartext-auth-allowssl-tcp-nossl: INFRASTRUCTURE_CONFIG := $(INFRASTRUCTURE_CONFIG),mongo/auth,sqlproxy/auth,sqlproxy/ssl/allow,sqlproxy/ssl/pem,client/auth/creds,client/auth/cleartext,client/ssl/disable
...
test-cleartext-auth-allowssl-unix-nossl: INFRASTRUCTURE_CONFIG := $(INFRASTRUCTURE_CONFIG),mongo/auth,sqlproxy/auth,sqlproxy/ssl/allow,sqlproxy/ssl/pem,client/auth/creds,client/auth/cleartext,client/ssl/disable,client/connection/unix-protocol
