...
test-require-ssl-failure: INFRASTRUCTURE_CONFIG = default,sqlproxy/ssl/require,sqlproxy/ssl/pem
...
test-require-ssl-success: INFRASTRUCTURE_CONFIG = default,sqlproxy/ssl/require,sqlproxy/ssl/pem,client/ssl/require
test-require-ssl-success: test-connect-success

# reject ssl connections when sslMode=disabled
test-disable-ssl-failure: INFRASTRUCTURE_CONFIG = default,sqlproxy/ssl/disabled,client/ssl/require
...
test-disable-ssl-success: INFRASTRUCTURE_CONFIG = default,sqlproxy/ssl/disabled,client/ssl/disable
test-disable-ssl-success: test-connect-success

# accept non-ssl connections when sslMode=allowSSL
test-allow-ssl-ssl: INFRASTRUCTURE_CONFIG = default,sqlproxy/ssl/allow,sqlproxy/ssl/pem,client/ssl/disable
test-allow-ssl-ssl: test-connect-success

# accept ssl connections when sslMode=allowSSL
test-allow-ssl-nossl: INFRASTRUCTURE_CONFIG = default,sqlproxy/ssl/allow,sqlproxy/ssl/pem,client/ssl/require
