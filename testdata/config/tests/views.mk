...
test-sample-auth-view-on-collection-latest: INFRASTRUCTURE_CONFIG := $(INFRASTRUCTURE_CONFIG),mongo/auth,mongo/other-user/read-view-only,sqlproxy/auth/admin-creds-other-user,sqlproxy/auth/enabled,sqlproxy/schema/mapping-majority,sqlproxy/schema/ns-view-only,sqlproxy/ssl/allow,sqlproxy/ssl/pem,client/auth/cleartext,client/ssl/require,client/auth/creds
