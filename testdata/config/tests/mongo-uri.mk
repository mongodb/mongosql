...
test-mongo-uri-read-preference-secondary: INFRASTRUCTURE_CONFIG := $(INFRASTRUCTURE_CONFIG),mongo/topology/replica-set,sqlproxy/schema/interval-2,mongo/uri/read-pref-secondary,sqlproxy/schema/drdl
...
test-mongo-uri-read-preference-primary: INFRASTRUCTURE_CONFIG := $(INFRASTRUCTURE_CONFIG),mongo/topology/replica-set,sqlproxy/schema/interval-2,mongo/uri/read-pref-primary,sqlproxy/schema/drdl
