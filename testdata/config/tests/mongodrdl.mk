...
test-drdl-auth: INFRASTRUCTURE_CONFIG = default,mongo/auth,drdl/auth/creds
test-drdl-auth: test-drdl-connect-success

# drdl should fail to connect with no credentials
test-drdl-auth-no-creds: INFRASTRUCTURE_CONFIG = default,mongo/auth
...
test-drdl-auth-wrong-creds: INFRASTRUCTURE_CONFIG = default,mongo/auth,drdl/auth/wrong-creds
test-drdl-auth-wrong-creds: EXPECTED_ERROR = Failed: can't create session: no servers available
test-drdl-auth-wrong-creds: test-drdl-connect-failure

# test that drdl connects with ssl
test-drdl-ssl: INFRASTRUCTURE_CONFIG = default,mongo/ssl/basic,drdl/ssl/enable
