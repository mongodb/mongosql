...
mysql -u root -e 'CREATE TABLE flights201406  (_id varchar(255), flight_date date, carrier_code varchar(255), tail_num varchar(255), flight_number int, origin_airport_id int, origin_city_market_id int, origin_airport_code varchar(255), origin_city_name varchar(255), origin_state varchar(255), dest_airport_id int, dest_city_market_id int, dest_airport_code varchar(255), dest_city_name varchar(255), dest_state varchar(255), dep_time int, diff_from_dep_time int, dep_delay int, arr_time int, diff_from_arr_time int, flight_time int, airline varchar(255), cancelled int, arr_delay int, carrier_delay int, late_aircraft_delay int, nas_delay int);' test
