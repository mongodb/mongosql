...
func init() {
	...
	definitions[MongoDBGitVersion] = &definition{
		...
		SQLType:          schema.SQLVarchar,
		GetValue:         func(c *Container) interface{} { return c.MongoDBGitVersion },
	}
	...
	definitions[MongoDBTopology] = &definition{
		...
		AllowedSetScopes: Scope(0), // not allowed to be set
		SQLType:          schema.SQLVarchar,
		GetValue:         func(c *Container) interface{} { return c.MongoDBTopology },
	}
	...
	definitions[MongoDBVersion] = &definition{
		...
		AllowedSetScopes: Scope(0), // not allowed to be set
		SQLType:          schema.SQLVarchar,
		GetValue:         func(c *Container) interface{} { return c.MongoDBVersion },
	}
