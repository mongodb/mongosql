...
func TestReconcile(t *testing.T) {
	...
	tests := []test{
		...
		{"avg(int)", NewSQLAvgFunctionExpr(false, []SQLExpr{intVal}),
			[]types.EvalType{types.EvalInt64}},
		{"avg(uint)", NewSQLAvgFunctionExpr(false, []SQLExpr{uintVal}),
			[]types.EvalType{types.EvalUint64}},
		{"avg(float)", NewSQLAvgFunctionExpr(false, []SQLExpr{floatVal}), []types.EvalType{types.EvalDouble}},
		{"avg(decimal)", NewSQLAvgFunctionExpr(false, []SQLExpr{decimalVal}), []types.EvalType{types.EvalDecimal128}},
		{"avg(bool)", NewSQLAvgFunctionExpr(false, []SQLExpr{boolVal}), []types.EvalType{types.EvalInt64}},
		{"avg(str)", NewSQLAvgFunctionExpr(false, []SQLExpr{strVal}), []types.EvalType{types.EvalDouble}},
		{"avg(date)", NewSQLAvgFunctionExpr(false, []SQLExpr{dateVal}), []types.EvalType{types.EvalInt64}},
		{"avg(datetime)", NewSQLAvgFunctionExpr(false, []SQLExpr{datetimeVal}), []types.EvalType{types.EvalDecimal128}},
		...
		{"sum(float)", NewSQLSumFunctionExpr(false, []SQLExpr{floatVal}), []types.EvalType{types.EvalDouble}},
		{"sum(decimal)", NewSQLSumFunctionExpr(false, []SQLExpr{decimalVal}), []types.EvalType{types.EvalDecimal128}},
		{"sum(bool)", NewSQLSumFunctionExpr(false, []SQLExpr{boolVal}), []types.EvalType{types.EvalInt64}},
		{"sum(str)", NewSQLSumFunctionExpr(false, []SQLExpr{strVal}), []types.EvalType{types.EvalDouble}},
		{"sum(date)", NewSQLSumFunctionExpr(false, []SQLExpr{dateVal}), []types.EvalType{types.EvalInt64}},
		{"sum(datetime)", NewSQLSumFunctionExpr(false, []SQLExpr{datetimeVal}), []types.EvalType{types.EvalDecimal128}},
		{"stdDev(float)", NewSQLStdDevFunctionExpr("", false, []SQLExpr{floatVal}), []types.EvalType{types.EvalDouble}},
		{"stdDev(decimal)", NewSQLStdDevFunctionExpr("", false, []SQLExpr{decimalVal}), []types.EvalType{types.EvalDecimal128}},
		{"stdDev(bool)", NewSQLStdDevFunctionExpr("", false, []SQLExpr{boolVal}), []types.EvalType{types.EvalInt64}},
		{"stdDev(str)", NewSQLStdDevFunctionExpr("", false, []SQLExpr{strVal}), []types.EvalType{types.EvalDouble}},
		{"stdDev(date)", NewSQLStdDevFunctionExpr("", false, []SQLExpr{dateVal}), []types.EvalType{types.EvalInt64}},
		{"stdDev(datetime)", NewSQLStdDevFunctionExpr("", false, []SQLExpr{datetimeVal}), []types.EvalType{types.EvalDecimal128}},
		{"stdDevSample(float)", NewSQLStdDevSampleFunctionExpr(false, []SQLExpr{floatVal}), []types.EvalType{types.EvalDouble}},
		{"stdDevSample(decimal)", NewSQLStdDevSampleFunctionExpr(false, []SQLExpr{decimalVal}), []types.EvalType{types.EvalDecimal128}},
		{"stdDevSample(bool)", NewSQLStdDevSampleFunctionExpr(false, []SQLExpr{boolVal}), []types.EvalType{types.EvalInt64}},
		{"stdDevSample(str)", NewSQLStdDevSampleFunctionExpr(false, []SQLExpr{strVal}), []types.EvalType{types.EvalDouble}},
		{"stdDevSample(date)", NewSQLStdDevSampleFunctionExpr(false, []SQLExpr{dateVal}), []types.EvalType{types.EvalInt64}},
		{"stdDevSample(datetime)", NewSQLStdDevSampleFunctionExpr(false, []SQLExpr{datetimeVal}), []types.EvalType{types.EvalDecimal128}},
...
func TestBuildUnflattenedProject(t *testing.T) {
	tests := []struct {
		name      string
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			actual, err := buildUnflattenedProject(ms)
