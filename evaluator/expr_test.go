...
func TestEvaluates(t *testing.T) {
	...
	t.Run("evaluates", func(t *testing.T) {
		...
		tests := []test{
			...
			{"sql_and_expr_with_null_1", "NULL && 1", NewSQLNullUntyped(knd)},
			{"sql_and_expr_with_null_2", "NULL && NULL", NewSQLNullUntyped(knd)},
			...
			// 	NewSQLDecimal128(knd, decimal.NewFromFloat(220826)),
			// },
			// {"sql_time_division_0", "TIME '11:04:13' / 0", NewSQLNullUntyped(knd)},
			// {
			// 	"sql_time_division_1",
			// 	"TIME '11:04:13' / 2",
			...
			{"sql_conv_5", "conv('74', 48, 3)", NewSQLNullUntyped(knd)},
			{"sql_conv_6", "conv('13', 1, 7)", NewSQLNullUntyped(knd)},
			{"sql_conv_7", "conv('-34', 5, 11)", NewSQLVarchar(knd, "-18")},
			{"sql_conv_8", "conv('-0', 5, 7)", NewSQLVarchar(knd, "0")},
			{"sql_case_expr_3", "CASE WHEN a = 245 THEN 'yes' END", NewSQLNullUntyped(knd)},
			...
			{"sql_divide_expr_0", "0 DIV 0", NewSQLNullUntyped(knd)},
			...
			{"sql_divide_expr_4", "NULL DIV 1", NewSQLNullUntyped(knd)},
			{"sql_divide_expr_5", "1 DIV NULL", NewSQLNullUntyped(knd)},
			...
			{"sql_in_expr_4", "NULL IN(0, 1)", NewSQLNullUntyped(knd)},
			{"sql_in_expr_5", "NULL IN(0, NULL)", NewSQLNullUntyped(knd)},
			...
			{"sql_like_expr_25", "NULL LIKE '1%'", NewSQLNullUntyped(knd)},
			{"sql_like_expr_26", "10 LIKE NULL", NewSQLNullUntyped(knd)},
			{"sql_like_expr_27", "NULL LIKE NULL", NewSQLNullUntyped(knd)},
			...
			{"sql_like_binary_expr_25", "NULL LIKE BINARY '1%'", NewSQLNullUntyped(knd)},
			{"sql_like_binary_expr_26", "10 LIKE BINARY NULL", NewSQLNullUntyped(knd)},
			{"sql_like_binary_expr_27", "NULL LIKE BINARY NULL", NewSQLNullUntyped(knd)},
			...
			{"sql_mixed_arithmetic_and_bool_7", "1+(NULL>6)", NewSQLNullUntyped(knd)},
			{"sql_mixed_arithmetic_and_bool_8", "NULL+(5>6)", NewSQLNullUntyped(knd)},
			...
			{"sql_mod_expr_0", "0 % 0", NewSQLNullUntyped(knd)},
			...
			{"sql_not_expr_4", "NOT NULL", NewSQLNullUntyped(knd)},
			...
			{"sql_or_expr_4", "NULL OR 0", NewSQLNullUntyped(knd)},
			{"sql_or_expr_5", "NULL OR NULL", NewSQLNullUntyped(knd)},
			...
			{"sql_not_regex_expr_8", "null REGEXP 'abc'", NewSQLNullUntyped(knd)},
			{"sql_not_regex_expr_9", "'a' REGEXP null", NewSQLNullUntyped(knd)},
			...
			{"sql_regex_expr_8", "null REGEXP 'abc'", NewSQLNullUntyped(knd)},
			{"sql_regex_expr_9", "'a' REGEXP null", NewSQLNullUntyped(knd)},
			{"sql_regex_expr_10", "2-1 REGEXP '1'", NewSQLBool(knd, true)},
			{"sql_scalar_abs_expr_0", "ABS(NULL)", NewSQLNullUntyped(knd)},
			...
			{"sql_scalar_acos_expr_0", "ACOS(NULL)", NewSQLNullUntyped(knd)},
			{"sql_scalar_acos_expr_1", "ACOS(20)", NewSQLNullUntyped(knd)},
			{"sql_scalar_acos_expr_2", "ACOS(-20)", NewSQLNullUntyped(knd)},
			...
			{"sql_scalar_asin_expr_0", "ASIN(NULL)", NewSQLNullUntyped(knd)},
			{"sql_scalar_asin_expr_1", "ASIN(20)", NewSQLNullUntyped(knd)},
			{"sql_scalar_asin_expr_2", "ASIN(-20)", NewSQLNullUntyped(knd)},
			{"sql_scalar_asin_expr_3", "ASIN('C')", NewSQLFloat(knd, 0)},
			{"sql_scalar_asin_expr_4", "ASIN(0)", NewSQLFloat(knd, 0)},
			{"sql_scalar_atan_expr_0", "ATAN(NULL)", NewSQLNullUntyped(knd)},
			...
			{"sql_ceil_0", "CEIL(NULL)", NewSQLNullUntyped(knd)},
			...
			{"sql_ceiling_expr_0", "CEIL(NULL)", NewSQLNullUntyped(knd)},
			...
			{"sql_ceiling_expr_4", "CEIL(0.56)", NewSQLFloat(knd, 1)},
			{"sql_ceiling_expr_5", "CEIL(-0.56)", NewSQLFloat(knd, 0)},
			...
			{"sql_char_length_0", "CHAR_LENGTH(NULL)", NewSQLNullUntyped(knd)},
			...
			{"sql_char_length_4", "CHARACTER_LENGTH(NULL)", NewSQLNullUntyped(knd)},
			...
			{"sql_coalesce_expr_0", "COALESCE(NULL)", NewSQLNullUntyped(knd)},
			...
			{"sql_coalesce_expr_5", "COALESCE(NULL, NULL, NULL)", NewSQLNullUntyped(knd)},
			{"sql_concat_expr_0", "CONCAT(NULL)", NewSQLNullUntyped(knd)},
			{"sql_concat_expr_1", "CONCAT('A')", NewSQLVarchar(knd, "A")},
			{"sql_concat_expr_2", "CONCAT('A', 'B')", NewSQLVarchar(knd, "AB")},
			{"sql_concat_expr_3", "CONCAT('A', NULL, 'B')", NewSQLNullUntyped(knd)},
			{"sql_concat_expr_4", "CONCAT('A', 123, 'B')", NewSQLVarchar(knd, "A123B")},
			{"sql_concat_ws_expr_0", "CONCAT_WS(NULL, NULL)", NewSQLNullUntyped(knd)},
			...
			{"sql_cos_expr_0", "COS(NULL)", NewSQLNullUntyped(knd)},
			...
			{"sql_cot_expr_0", "COT(NULL)", NewSQLNullUntyped(knd)},
			...
			*/
			...
			{"sql_date_diff_3", "DATEDIFF(NULL, '2017-09-30 12:19:50')", NewSQLNullUntyped(knd)},
			...
			{"sql_date_diff_10", "DATEDIFF('00-09-1', '12-06-07')",
				NewSQLInt64(knd, -4297)},
			{"sql_date_format_0", "DATE_FORMAT('2009-10-04', NULL)", NewSQLNullUntyped(knd)},
			{"sql_date_format_1", "DATE_FORMAT(NULL, '2009-10-04')", NewSQLNullUntyped(knd)},
			{
				"sql_date_format_2",
			...
			{"sql_date_name_0", "DAYNAME(NULL)", NewSQLNullUntyped(knd)},
			{"sql_date_name_1", "DAYNAME(14)", NewSQLNullUntyped(knd)},
			...
			{"sql_date_of_month_0", "DAYOFMONTH(NULL)", NewSQLNullUntyped(knd)},
			{"sql_date_of_month_1", "DAYOFMONTH(14)", NewSQLNullUntyped(knd)},
			{"sql_date_of_month_2", "DAYOFMONTH('2016-01-01')", NewSQLInt64(knd, 1)},
			{"sql_date_of_month_3", "DAYOFMONTH('2016-1-1')", NewSQLInt64(knd, 1)},
			{"sql_date_of_week_0", "DAYOFWEEK(NULL)", NewSQLNullUntyped(knd)},
			{"sql_date_of_week_1", "DAYOFWEEK(14)", NewSQLNullUntyped(knd)},
			{"sql_date_of_week_2", "DAYOFWEEK('2016-01-01')", NewSQLInt64(knd, 6)},
			{"sql_date_of_week_3", "DAYOFWEEK('2016-1-1')", NewSQLInt64(knd, 6)},
			{"sql_date_of_year_0", "DAYOFYEAR(NULL)", NewSQLNullUntyped(knd)},
			{"sql_date_of_year_1", "DAYOFYEAR(14)", NewSQLNullUntyped(knd)},
			{"sql_date_of_year_2", "DAYOFYEAR('2016-1-1')", NewSQLInt64(knd, 1)},
			{"sql_date_of_year_3", "DAYOFYEAR('2016-01-01')", NewSQLInt64(knd, 1)},
			{"sql_degrees_0", "DEGREES(NULL)", NewSQLNullUntyped(knd)},
			{"sql_degrees_1", "DEGREES(20)", NewSQLFloat(knd, 1145.9155902616465)},
			{"sql_degrees_2", "DEGREES(-20)", NewSQLFloat(knd, -1145.9155902616465)},
			{"sql_elt_expr_0", "ELT(NULL, 'a', 'b')", NewSQLNullUntyped(knd)},
			{"sql_elt_expr_1", "ELT(0, 'a', 'b')", NewSQLNullUntyped(knd)},
			{"sql_elt_expr_2", "ELT(1, 'a', 'b')", NewSQLVarchar(knd, "a")},
			{"sql_elt_expr_3", "ELT(2, 'a', 'b')", NewSQLVarchar(knd, "b")},
			{"sql_elt_expr_4", "ELT(3, 'a', 'b', NULL)", NewSQLNullUntyped(knd)},
			{"sql_elt_expr_5", "ELT(4, 'a', 'b', NULL)", NewSQLNullUntyped(knd)},
			{"sql_exp_expr_0", "EXP(NULL)", NewSQLNullUntyped(knd)},
			...
			{"sql_extract_expr_0", "EXTRACT(YEAR FROM NULL)", NewSQLNullUntyped(knd)},
			{
				"sql_extract_expr_1",
			...
			{"sql_floor_expr_0", "FLOOR(NULL)", NewSQLNullUntyped(knd)},
			...
			{"sql_from_unixtime_0", "FROM_UNIXTIME(NULL)", NewSQLNullUntyped(knd)},
			{"sql_from_unixtime_1", "FROM_UNIXTIME(-1)", NewSQLNullUntyped(knd)},
			{
				"sql_from_unixtime_2",
			...
			{"sql_hour_0", "HOUR(NULL)", NewSQLNullUntyped(knd)},
			{"sql_hour_1", "HOUR('sdg')", NewSQLInt64(knd, 0)},
			{"sql_hour_2", "HOUR('10:23:52')", NewSQLInt64(knd, 10)},
			{"sql_hour_3", "HOUR('10:61:52')", NewSQLNullUntyped(knd)},
			...
			{"sql_if_null_2", "IFNULL(NULL,NULL)", NewSQLNullUntyped(knd)},
			...
			{"sql_insert_expr_0", "INSERT('Quadratic', NULL, 4, 'What')", NewSQLNullUntyped(knd)},
			{
				"sql_insert_expr_1",
			...
			{"sql_instr_expr_0", "INSTR(NULL, NULL)", NewSQLNullUntyped(knd)},
			...
			{"sql_lcase_0", "LCASE(NULL)", NewSQLNullUntyped(knd)},
			{"sql_lcase_1", "LCASE('sDg')", NewSQLVarchar(knd, "sdg")},
			{"sql_lcase_2", "LCASE(124)", NewSQLVarchar(knd, "124")},
			{"sql_lowercase_0", "LOWER(NULL)", NewSQLNullUntyped(knd)},
			...
			{"sql_left_null_arg_0", "LEFT(NULL, NULL)", NewSQLNullUntyped(knd)},
			{"sql_left_null_arg_1", "LEFT('hi', NULL)", NewSQLNullUntyped(knd)},
			{"sql_left_null_arg_2", "LEFT(NULL, 5)", NewSQLNullUntyped(knd)},
			...
			{"sql_log2_0", "LOG2(NULL)", NewSQLNullUntyped(knd)},
			{"sql_log2_1", "LOG2(4)", NewSQLFloat(knd, 2)},
			{"sql_log2_2", "LOG2(-100)", NewSQLNullUntyped(knd)},
			{"sql_log10_0", "LOG10(NULL)", NewSQLNullUntyped(knd)},
			{"sql_log10_1", "LOG10('sdg')", NewSQLNullUntyped(knd)},
			{"sql_log10_2", "LOG10(2)", NewSQLFloat(knd, 0.3010299956639812)},
			{"sql_log10_3", "LOG10(100)", NewSQLFloat(knd, 2)},
			{"sql_log10_4", "LOG10(0)", NewSQLNullUntyped(knd)},
			{"sql_log10_5", "LOG10(-100)", NewSQLNullUntyped(knd)},
			{"sql_ltrim_0", "LTRIM(NULL)", NewSQLNullUntyped(knd)},
			{"sql_ltrim_1", "LTRIM('   barbar')", NewSQLVarchar(knd, "barbar")},
			{"sql_md5_0", "MD5(NULL)", NewSQLNullUntyped(knd)},
			{"sql_md5_1", "MD5(NULL + NULL)", NewSQLNullUntyped(knd)},
			{
				"sql_md5_2",
				"MD5('testing')",
			...
			{"sql_microsecond_0", "MICROSECOND(NULL)", NewSQLNullUntyped(knd)},
			{"sql_microsecond_1", "MICROSECOND('')", NewSQLNullUntyped(knd)},
			...
			{"sql_mid_0", "MID('foobarbar', 4, NULL)", NewSQLNullUntyped(knd)},
			...
			{"sql_minute_0", "MINUTE(NULL)", NewSQLNullUntyped(knd)},
			{"sql_minute_1", "MINUTE('sdg')", NewSQLInt64(knd, 0)},
			{"sql_minute_2", "MINUTE('10:23:52')", NewSQLInt64(knd, 23)},
			{"sql_minute_3", "MINUTE('10:61:52')", NewSQLNullUntyped(knd)},
			{"sql_minute_4", "MINUTE('10:23:52.25.26.27.28')", NewSQLInt64(knd, 23)},
			{"sql_mod_0", "MOD(NULL, NULL)", NewSQLNullUntyped(knd)},
			{"sql_mod_1", "MOD(234, NULL)", NewSQLNullUntyped(knd)},
			{"sql_mod_2", "MOD(NULL, 10)", NewSQLNullUntyped(knd)},
			{"sql_mod_3", "MOD(234, 0)", NewSQLNullUntyped(knd)},
			{"sql_mod_4", "MOD(234, 10)", NewSQLFloat(knd, 4)},
			{"sql_mod_5", "MOD(253, 7)", NewSQLFloat(knd, 1)},
			{"sql_mod_6", "MOD(34.5, 3)", NewSQLFloat(knd, 1.5)},
			{"sql_month_0", "MONTH(NULL)", NewSQLNullUntyped(knd)},
			{"sql_month_1", "MONTH('sdg')", NewSQLNullUntyped(knd)},
			{"sql_month_2", "MONTH('2016-1-01 10:23:52')", NewSQLInt64(knd, 1)},
			{"sql_month_name_expr_0", "MONTHNAME(NULL)", NewSQLNullUntyped(knd)},
			{"sql_month_name_expr_1", "MONTHNAME('sdg')", NewSQLNullUntyped(knd)},
			{
				"sql_month_name_expr_2",
				"MONTHNAME('2016-1-01 10:23:52')",
				NewSQLVarchar(knd, "January"),
			},
			{"sql_null_if_0", "NULLIF(1,1)", NewSQLNullUntyped(knd)},
			{"sql_null_if_1", "NULLIF(1,3)", NewSQLInt64(knd, 1)},
			{"sql_null_if_2", "NULLIF(null, null)", NewSQLNullUntyped(knd)},
			{"sql_null_if_3", "NULLIF(null, 4)", NewSQLNullUntyped(knd)},
			{"sql_null_if_4", "NULLIF(3, null)", NewSQLInt64(knd, 3)},
			//test{"sql_null_if_5", "NULLIF(3, '3')", NewSQLNullUntyped(knd)},
			{"sql_null_if_6", "NULLIF('abc', 'abc')", NewSQLNullUntyped(knd)},
			//test{"sql_null_if_7", "NULLIF('abc', 3)", NewSQLVarchar(knd, "abc")},
			//test{"sql_null_if_8", "NULLIF('1', true)", NewSQLNullUntyped(knd)},
			//test{"sql_null_if_9", "NULLIF('1', false)", NewSQLVarchar(knd, "1")},
			{"sql_pi_expr", "PI()", NewSQLFloat(knd, 3.141592653589793116)},
			{"sql_quarter_0", "QUARTER(NULL)", NewSQLNullUntyped(knd)},
			{"sql_quarter_1", "QUARTER('sdg')", NewSQLNullUntyped(knd)},
			...
			{"sql_radians_0", "RADIANS(NULL)", NewSQLNullUntyped(knd)},
			...
			{"sql_repeat_0", "REPEAT(NULL, NULL)", NewSQLNullUntyped(knd)},
			{"sql_repeat_1", "REPEAT(NULL, 3)", NewSQLNullUntyped(knd)},
			{"sql_repeat_2", "REPEAT('apples', NULL)", NewSQLNullUntyped(knd)},
			...
			{"sql_repeat_12", "REPEAT(NULL, 4)", NewSQLNullUntyped(knd)},
			...
			{"sql_replace_0", "REPLACE(NULL, NULL, NULL)", NewSQLNullUntyped(knd)},
			...
			{"sql_reverse_0", "REVERSE(NULL)", NewSQLNullUntyped(knd)},
			...
			// if any argument null, should return null
			{"sql_right_null_0", "RIGHT(NULL, NULL)", NewSQLNullUntyped(knd)},
			{"sql_right_null_1", "RIGHT('hi', NULL)", NewSQLNullUntyped(knd)},
			{"sql_right_null_2", "RIGHT(NULL, 5)", NewSQLNullUntyped(knd)},
			// basic cases w/ string, int inputs and positive int length
			...
			{"sql_round_0", "ROUND(NULL, NULL)", NewSQLNullUntyped(knd)},
			{"sql_round_1", "ROUND(NULL, 4)", NewSQLNullUntyped(knd)},
			...
			{"sql_rtrim_0", "RTRIM(NULL)", NewSQLNullUntyped(knd)},
			...
			{"sql_lpad_null_0", "LPAD(NULL, 5, 'a')", NewSQLNullUntyped(knd)},
			{"sql_lpad_null_1", "LPAD('hi', NULL, 'a')", NewSQLNullUntyped(knd)},
			{"sql_lpad_null_2", "LPAD('hi', 5, NULL)", NewSQLNullUntyped(knd)},
			{"sql_lpad_null_3", "LPAD(NULL, NULL, NULL)", NewSQLNullUntyped(knd)},
			// str: empty
			...
			// len < 0
			{"sql_lpad_neg_length", "LPAD('hi', -1, 'a')", NewSQLNullUntyped(knd)},
			// len = 0
			...
			{"sql_lpad_edge_11", "LPAD('hello', -0.5, 'x')", NewSQLNullUntyped(knd)},
			...
			// nulls in various positions
			{"sql_rpad_null_0", "RPAD(NULL, 5, 'a')", NewSQLNullUntyped(knd)},
			{"sql_rpad_null_1", "RPAD('hi', NULL, 'a')", NewSQLNullUntyped(knd)},
			{"sql_rpad_null_2", "RPAD('hi', 5, NULL)", NewSQLNullUntyped(knd)},
			{"sql_rpad_null_3", "RPAD(NULL, NULL, NULL)", NewSQLNullUntyped(knd)},
			// str: empty
			...
			// len < 0
			{"sql_rpad_len", "RPAD('hi', -1, 'a')", NewSQLNullUntyped(knd)},
			// len = 0
			...
			{"sql_rpad_len_14", "RPAD('hello', -0.5, 'x')", NewSQLNullUntyped(knd)},
			// len string values close to 0 - always round toward 0
			...
			{"sql_sin_0", "SIN(NULL)", NewSQLNullUntyped(knd)},
			...
			{"sql_space_0", "SPACE(NULL)", NewSQLNullUntyped(knd)},
			{"sql_space_1", "SPACE(5)", NewSQLVarchar(knd, "     ")},
			{"sql_space_2", "SPACE(-3)", NewSQLVarchar(knd, "")},
			{"sql_sort_0", "SQRT(NULL)", NewSQLNullUntyped(knd)},
			{"sql_sort_1", "SQRT('sdg')", NewSQLFloat(knd, 0)},
			{"sql_sort_2", "SQRT(-16)", NewSQLNullUntyped(knd)},
			{"sql_sort_3", "SQRT(4)", NewSQLFloat(knd, 2)},
			{"sql_sort_4", "SQRT(20)", NewSQLFloat(knd, 4.47213595499958)},
			{"sql_substring_0", "SUBSTRING(NULL, 4)", NewSQLNullUntyped(knd)},
			{"sql_substring_1", "SUBSTRING('foobarbar', NULL)", NewSQLNullUntyped(knd)},
			{"sql_substring_2", "SUBSTRING('foobarbar', 4, NULL)", NewSQLNullUntyped(knd)},
			...
			{"sql_substring_9", "SUBSTR(NULL, 4)", NewSQLNullUntyped(knd)},
			{"sql_substring_10", "SUBSTR('foobarbar', NULL)", NewSQLNullUntyped(knd)},
			{"sql_substring_11", "SUBSTR('foobarbar', 4, NULL)", NewSQLNullUntyped(knd)},
			...
			{"sql_substring_28", "SUBSTRING(NULL from 4)", NewSQLNullUntyped(knd)},
			{"sql_substring_29", "SUBSTRING('foobarbar' from NULL)", NewSQLNullUntyped(knd)},
			{"sql_substring_30", "SUBSTRING('foobarbar' from 4 for NULL)", NewSQLNullUntyped(knd)},
			{
				"sql_substring_31",
			...
			{"sql_substring_37", "SUBSTR(NULL FROM 4)", NewSQLNullUntyped(knd)},
			{"sql_substring_38", "SUBSTR('foobarbar' FROM NULL)", NewSQLNullUntyped(knd)},
			{"sql_substring_39", "SUBSTR('foobarbar' FROM 4 FOR NULL)", NewSQLNullUntyped(knd)},
			{
				"sql_substring_40",
			...
			{"sql_substring_68", "SUBSTR(NULL, -4)", NewSQLNullUntyped(knd)},
			{"sql_substring_69", "SUBSTR(NULL, -4, 2)", NewSQLNullUntyped(knd)},
			{"sql_substring_70", "SUBSTR('this' FROM NULL FOR 2)", NewSQLNullUntyped(knd)},
			{"sql_substring_71", "SUBSTR('this', 2, NULL )", NewSQLNullUntyped(knd)},
			{"sql_substring_72", "SUBSTR('this' FROM 3 FOR NULL)", NewSQLNullUntyped(knd)},
			{
			...
			{"sql_tan_0", "TAN(NULL)", NewSQLNullUntyped(knd)},
			...
			{"sql_time_to_sec_0", "TIME_TO_SEC(NULL)", NewSQLNullUntyped(knd)},
			...
			{"sql_time_to_sec_14", "TIME_TO_SEC(534422333)", NewSQLNullUntyped(knd)},
			{"sql_time_to_sec_15", "TIME_TO_SEC(539911)", NewSQLNullUntyped(knd)},
			{"sql_time_to_sec_16", "TIME_TO_SEC(8991111)", NewSQLNullUntyped(knd)},
			...
			{"sql_timediff_0", "TIMEDIFF('2000:11:11 00:00:00', NULL)", NewSQLNullUntyped(knd)},
			{"sql_timediff_1", "TIMEDIFF(NULL, '2000:11:11 00:00:00')", NewSQLNullUntyped(knd)},
			{
				"sql_timediff_2",
			...
			{"sql_trim_0", "TRIM(NULL)", NewSQLNullUntyped(knd)},
			...
			{"sql_truncate_0", "TRUNCATE(NULL, 2)", NewSQLNullUntyped(knd)},
			{"sql_truncate_1", "TRUNCATE(1234.1234, NULL)", NewSQLNullUntyped(knd)},
			{"sql_truncate_2", "TRUNCATE(1 / 0, 2)", NewSQLNullUntyped(knd)},
			{"sql_truncate_3", "TRUNCATE(1234.1234, 1 / 0)", NewSQLNullUntyped(knd)},
			...
			{"sql_ucase_0", "UCASE(NULL)", NewSQLNullUntyped(knd)},
			{"sql_ucase_1", "UCASE('sdg')", NewSQLVarchar(knd, "SDG")},
			{"sql_ucase_2", "UCASE(124)", NewSQLVarchar(knd, "124")},
			{"sql_ucase_3", "UPPER(NULL)", NewSQLNullUntyped(knd)},
			...
			{"sql_unix_timestamp_0", "UNIX_TIMESTAMP(NULL)", NewSQLNullUntyped(knd)},
			...
			*/
			...
			{"sql_weekday_0", "WEEKDAY(NULL)", NewSQLNullUntyped(knd)},
			{"sql_weekday_1", "WEEKDAY('sdg')", NewSQLNullUntyped(knd)},
			...
			{"sql_unary_minus_3", "- null", NewSQLNullUntyped(knd)},
		...
		aggTests := []test{
			...
			{"sql_agg_expr_avg_3", "AVG(c)", NewSQLNullUntyped(knd)},
			...
			{"sql_group_concat_expr_5", "GROUP_CONCAT(a,c)", NewSQLNullUntyped(knd)},
			{"sql_group_concat_expr_6", "GROUP_CONCAT(null)", NewSQLNullUntyped(knd)},
			{"sql_min_expr_0", "MIN(NULL)", NewSQLNullUntyped(knd)},
			{"sql_min_expr_1", "MIN(a)", NewSQLInt64(knd, 3)},
			{"sql_min_expr_2", "MIN(b)", NewSQLInt64(knd, 3)},
			{"sql_min_expr_3", "MIN(c)", NewSQLNullUntyped(knd)},
			{"sql_min_expr_4", "MIN('a')", NewSQLVarchar(knd, "a")},
			{"sql_min_expr_5", "MIN(-20)", NewSQLInt64(knd, -20)},
			{"sql_min_expr_6", "MIN(20)", NewSQLInt64(knd, 20)},
			{"sql_max_expr_0", "MAX(NULL)", NewSQLNullUntyped(knd)},
			{"sql_max_expr_1", "MAX(a)", NewSQLInt64(knd, 5)},
			{"sql_max_expr_2", "MAX(b)", NewSQLInt64(knd, 6)},
			{"sql_max_expr_3", "MAX(c)", NewSQLNullUntyped(knd)},
		...
		t.Run("adddate", func(t *testing.T) {
			...
			tests := []test{
				{"sql_add_date_0", "ADDDATE(NULL, INTERVAL 1 YEAR)", NewSQLNullUntyped(knd)},
				{
					"sql_add_date_1",
		...
		t.Run("convert", func(t *testing.T) {
			...
			tests := []test{
				...
				{"sql_convert_expr_67", "CONVERT(true, DATE)", NewSQLNullUntyped(knd)},
				{
					"sql_convert_expr_68",
				...
				{"sql_convert_expr_70", "CONVERT(NULL, DATETIME)", NewSQLNullUntyped(knd)},
				{"sql_convert_expr_71", "CONVERT(-3.4, DATETIME)", NewSQLNullUntyped(knd)},
				...
				{"sql_convert_expr_74", "CONVERT(true, DATETIME)", NewSQLNullUntyped(knd)},
				{"sql_convert_expr_75", "CONVERT(3, SQL_TIMESTAMP)", NewSQLNullUntyped(knd)},
				{
					"sql_convert_expr_76",
					"CONVERT(TIMESTAMP '2006-05-11 12:32:12', DATETIME)",
					NewSQLTimestamp(knd, t1),
		...
		t.Run("date", func(t *testing.T) {
			...
			tests := []test{
				...
				{"sql_date_non_paddable_0", "DATE(1)", NewSQLNullUntyped(knd)},
		...
		t.Run("date_sub, subdate", func(t *testing.T) {
			...
			tests := []test{
				...
				{"sql_date_sub_1", "DATE_SUB(NULL, INTERVAL 1 YEAR)", NewSQLNullUntyped(knd)},
				{
					"sql_date_sub_2",
		...
		t.Run("from_days", func(t *testing.T) {
			...
			tests := []test{
				{"sql_from_days_0", "FROM_DAYS(NULL)", NewSQLNullUntyped(knd)},
		...
		t.Run("greatest", func(t *testing.T) {
			...
			tests := []test{
				{"sql_greatest_expr_0", "GREATEST(NULL, 1, 2)", NewSQLNullUntyped(knd)},
		...
		t.Run("makedate", func(t *testing.T) {
			...
			tests := []test{
				{"sql_makedate_0", "MAKEDATE(NULL, 4)", NewSQLNullUntyped(knd)},
				{"sql_makedate_1", "MAKEDATE(2004, 0)", NewSQLNullUntyped(knd)},
				{"sql_makedate_2", "MAKEDATE(9999, 370)", NewSQLNullUntyped(knd)},
		...
		t.Run("str_to_date", func(t *testing.T) {
			...
			tests := []test{
				{"sql_str_to_date_0", "STR_TO_DATE(NULL, 4)", NewSQLNullUntyped(knd)},
				{"sql_str_to_date_1", "STR_TO_DATE('foobarbar', NULL)", NewSQLNullUntyped(knd)},
				{
					"sql_str_to_date_2",
		...
		t.Run("timestamp", func(t *testing.T) {
			...
			tests := []test{
				{"sql_timestamp_0", "TIMESTAMP(NULL)", NewSQLNullUntyped(knd)},
				{"sql_timestamp_1", "TIMESTAMP(NULL, NULL)", NewSQLNullUntyped(knd)},
				{"sql_timestamp_2", "TIMESTAMP(NULL, '12:22:22')", NewSQLNullUntyped(knd)},
				{"sql_timestamp_3", "TIMESTAMP('2002-01-02', NULL)", NewSQLNullUntyped(knd)},
				{
					"sql_timestamp_4",
