...
func TestEvaluates(t *testing.T) {
	...
	runTypeTests := func(t *testing.T, ctx *evaluator.EvalCtx, tests []typeTest) {
		...
		for _, test := range tests {
			t.Run(test.name, func(t *testing.T) {
				...
				req.Nil(err, "unable to get SQLExpr for sql statement")
				result := subject.Type()
				req.Equal(result, test.result, "type of evaluated SQLExpr does not match expected type")
			})
		}
	}
	...
	t.Run("evaluates", func(t *testing.T) {
		...
		// defines the scalar functions expressions to evaluates, along with the name for the test and the expected result
		tests := []test{
			...
			{"sql_time_expr_with_add_0", "TIME '11:04:13' + 0", evaluator.SQLDecimal128(decimal.NewFromFloat(110413))},
			{"sql_time_expr_with_add_1", "TIME '11:04:13' + 2", evaluator.SQLDecimal128(decimal.NewFromFloat(110415))},
			{"sql_time_expr_with_add_2", "TIME '11:04:13' + '2'", evaluator.SQLDecimal128(decimal.NewFromFloat(110415))},
			{"sql_time_expr_with_add_3", "'2' + TIME '11:04:13'", evaluator.SQLDecimal128(decimal.NewFromFloat(110415))},
			{"sql_timestamp_expr_with_add_0", "TIMESTAMP '2014-04-13 11:04:13' + 0", evaluator.SQLDecimal128(decimal.NewFromFloat(20140413110413))},
			{"sql_timestamp_expr_with_add_1", "TIMESTAMP '2014-04-13 11:04:13' + 2", evaluator.SQLDecimal128(decimal.NewFromFloat(20140413110415))},
			...
			{"sql_time_expr_with_subtract_0", "TIME '11:04:13' - 0", evaluator.SQLDecimal128(decimal.NewFromFloat(110413))},
			{"sql_time_expr_with_subtract_1", "TIME '11:04:13' - 2", evaluator.SQLDecimal128(decimal.NewFromFloat(110411))},
			{"sql_time_expr_with_subtract_2", "TIME '11:04:13' - '2'", evaluator.SQLDecimal128(decimal.NewFromFloat(110411))},
			{"sql_timestamp_expr_with_subtract_0", "TIMESTAMP '2014-04-13 11:04:13' - 0", evaluator.SQLDecimal128(decimal.NewFromFloat(20140413110413))},
			{"sql_timestamp_expr_with_subtract_1", "TIMESTAMP '2014-04-13 11:04:13' - 2", evaluator.SQLDecimal128(decimal.NewFromFloat(20140413110411))},
			...
			{"sql_time_expr_with_multiply_0", "TIME '11:04:13' * 0", evaluator.SQLDecimal128(decimal.NewFromFloat(0))},
			{"sql_time_expr_with_multiply_1", "TIME '11:04:13' * 2", evaluator.SQLDecimal128(decimal.NewFromFloat(220826))},
			{"sql_time_expr_with_multiply_2", "TIME '11:04:13' * '2'", evaluator.SQLDecimal128(decimal.NewFromFloat(220826))},
			{"sql_timestamp_expr_with_multiply_0", "TIMESTAMP '2014-04-13 11:04:13' * 0", evaluator.SQLDecimal128(decimal.NewFromFloat(0))},
			{"sql_timestamp_expr_with_multiply_1", "TIMESTAMP '2014-04-13 11:04:13' * 2", evaluator.SQLDecimal128(decimal.NewFromFloat(40280826220826))},
			{"sql_float_division_expr_0", "1.2 / 0.2", evaluator.SQLDecimal128(decimal.New(600000, -5))},
			{"sql_float_division_expr_1", "1.2 / 0.23", evaluator.SQLDecimal128(decimal.New(521739, -5))},
			...
			{"sql_time_division_1", "TIME '11:04:13' / 2", evaluator.SQLDecimal128(decimal.New(552065000, -4))},
			{"sql_time_division_2", "TIME '11:04:13' / '2'", evaluator.SQLDecimal128(decimal.New(552065000, -4))},
			{"sql_timestamp_division_0", "TIMESTAMP '2014-04-13 11:04:13' / 0", evaluator.SQLNull},
			{"sql_timestamp_division_1", "TIMESTAMP '2014-04-13 11:04:13' / 2", evaluator.SQLDecimal128(decimal.New(100702065552065000, -4))},
			...
			{"sql_date_greater_than_1", "DATE '2014-04-13' > DATE '2014-04-14'", evaluator.SQLFalse},
			...
			{"sql_case_expr_0", "CASE 3 WHEN 3 THEN 'three' WHEN 1 THEN 'one' ELSE 'else' END", evaluator.SQLVarchar("three")},
			{"sql_case_expr_1", "CASE WHEN 5 > 3 THEN 'true' else 'false' END", evaluator.SQLVarchar("true")},
			{"sql_case_expr_2", "CASE WHEN a = 123 THEN 'yes' else 'no' END", evaluator.SQLVarchar("yes")},
			...
			{"sql_date_is_bool_expr_1", "TIMESTAMP '2008-04-06 15:32:23' is true", evaluator.SQLTrue},
			...
			{"sql_is_not_expr_12", "TIMESTAMP '2008-04-06 15:32:23' is not true", evaluator.SQLFalse},
			...
			{"sql_like_expr_22", "NOW() LIKE '" + strconv.Itoa(time.Now().Year()) + "%' ", evaluator.SQLTrue},
			...
			{"sql_ascii_5", "ASCII('Č')", evaluator.SQLInt(196)}, // This is actually 268, but the first byte is 196
			...
			{"sql_char_expr_2", "CHAR(77,121,NULL, 83, NULL, 81,'76')", evaluator.SQLVarchar("MySQL")},
			...
			{"sql_concat_ws_expr_4", "CONCAT_WS(',','A', 123, 'B')", evaluator.SQLVarchar("A,123,B")},
			...
			//		{"sql_current_date_expr", "CURRENT_DATE()", evaluator.SQLDate{Time: time.Now().UTC()}},
			//		{"sql_current_ts_0", "CURRENT_TIMESTAMP()", evaluator.SQLTimestamp{Time: time.Now().UTC()}},
			//		{"sql_current_ts_1", "CURRENT_TIMESTAMP", evaluator.SQLTimestamp{Time: time.Now().UTC()}},
			//		{"sql_curtime_0", "CURRENT_TIMESTAMP()", evaluator.SQLTimestamp{Time: time.Now().UTC()}},
			//		{"sql_curtime_1", "CURRENT_TIMESTAMP", evaluator.SQLTimestamp{Time: time.Now().UTC()}},
			//		{"sql_utc_ts_0", "UTC_TIMESTAMP()", evaluator.SQLTimestamp{Time: time.Now().UTC()}},
			//		{"sql_utc_ts_1", "UTC_TIMESTAMP", evaluator.SQLTimestamp{Time: time.Now().UTC()}},
			//		{"sql_now_0", "NOW()", evaluator.SQLTimestamp{Time: time.Now().UTC()}},
			...
			{"sql_date_diff_0", "DATEDIFF('2017-01-01', '2016-01-01 23:08:56')", evaluator.SQLInt(366)},
			{"sql_date_diff_1", "DATEDIFF('2017-01-01', '2017-01-01')", evaluator.SQLInt(0)},
			{"sql_date_diff_2", "DATEDIFF('2017-08-23 10:40:43', '2017-09-30 12:19:50')", evaluator.SQLInt(-38)},
			...
			{"sql_date_diff_6", "DATEDIFF(20170823104043, '2017-09-30 12:19:50')", evaluator.SQLInt(-38)},
			{"sql_date_diff_7", "DATEDIFF(20170823.09809, '2017-09-30 12:19:50')", evaluator.SQLInt(-38)},
			{"sql_date_diff_8", "DATEDIFF('biconnectorisfun', '2017-09-30 12:19:50')", evaluator.SQLNull},
			...
			{"sql_date_format_2", "DATE_FORMAT('2009-10-04 22:23:00', '%W %M 01 %Y')", evaluator.SQLVarchar("Sunday October 01 2009")},
			{"sql_date_format_3", "DATE_FORMAT('2009-10-04 22:23:00', '%W %M %Y')", evaluator.SQLVarchar("Sunday October 2009")},
			{"sql_date_format_4", "DATE_FORMAT('2007-10-04 22:23:00', '%H:01:%i:%s')", evaluator.SQLVarchar("22:01:23:00")},
			{"sql_date_format_5", "DATE_FORMAT('2007-10-04 22:23:00', '%H:%g:01%%:%i:%s%')", evaluator.SQLVarchar("22:%g:01%:23:00%")},
			{"sql_date_format_6", "DATE_FORMAT('2007-10-04 22:23:00', '%H:%i:%s')", evaluator.SQLVarchar("22:23:00")},
			{"sql_date_format_7", "DATE_FORMAT('1900-10-04 22:23:00', '%D %y %a %d %m %b %j')", evaluator.SQLVarchar("4th 00 Thu 04 10 Oct 277")},
			{"sql_date_format_8", "DATE_FORMAT('1997-10-04 22:23:00', '%H %k %I %r %T %S %w')", evaluator.SQLVarchar("22 22 10 10:23:00 PM 22:23:00 00 6")},
			{"sql_date_format_9", "DATE_FORMAT('1999-01-01', '%X %V')", evaluator.SQLVarchar("1998 52")},
			{"sql_date_format_10", "DATE_FORMAT('1989-05-14 01:03:01.232335','%a|%b|%c|%D|%d|%e|%f|%H|%h|%I|%i|%j|%k|%l|%M|%m|%p|%r|%S|%s|%T|%U|%u|%V|%v|%W|%w|%X|%x|%Y|%y|%%|%x')", evaluator.SQLVarchar("Sun|May|5|14th|14|14|232335|01|01|01|03|134|1|1|May|05|AM|01:03:01 AM|01|01|01:03:01|20|19|20|19|Sunday|0|1989|1989|1989|89|%|1989")},
			{"sql_date_format_11", "DATE_FORMAT('1900-10-04 22:23:00', '%a|%b|%c|%D|%d|%e|%f|%H|%h|%I|%i|%j|%k|%l|%M|%m|%p|%r|%S|%s|%T|%U|%u|%V|%v|%W|%w|%X|%x|%Y|%y|%%|%x')", evaluator.SQLVarchar("Thu|Oct|10|4th|04|4|000000|22|10|10|23|277|22|10|October|10|PM|10:23:00 PM|00|00|22:23:00|39|40|39|40|Thursday|4|1900|1900|1900|00|%|1900")},
			{"sql_date_format_12", "DATE_FORMAT('1983-07-05 23:22', '%a|%b|%c|%D|%d|%e|%f|%H|%h|%I|%i|%j|%k|%l|%M|%m|%p|%r|%S|%s|%T|%U|%u|%V|%v|%W|%w|%X|%x|%Y|%y|%%|%x')", evaluator.SQLVarchar("Tue|Jul|7|5th|05|5|000000|23|11|11|22|186|23|11|July|07|PM|11:22:00 PM|00|00|23:22:00|27|27|27|27|Tuesday|2|1983|1983|1983|83|%|1983")},
			...
			{"sql_extract_expr_1", "EXTRACT(YEAR FROM TIMESTAMP '2006-04-07 07:14:23')", evaluator.SQLInt(2006)},
			{"sql_extract_expr_2", "EXTRACT(QUARTER FROM TIMESTAMP '2006-04-07 07:14:23')", evaluator.SQLInt(2)},
			{"sql_extract_expr_3", "EXTRACT(WEEK FROM TIMESTAMP '2006-04-07 07:14:23')", evaluator.SQLInt(14)},
			{"sql_extract_expr_4", "EXTRACT(DAY FROM TIMESTAMP '2006-04-07 07:14:23')", evaluator.SQLInt(7)},
			{"sql_extract_expr_5", "EXTRACT(HOUR FROM TIMESTAMP '2006-04-07 07:14:23')", evaluator.SQLInt(7)},
			{"sql_extract_expr_6", "EXTRACT(MINUTE FROM TIMESTAMP '2006-04-07 07:14:23')", evaluator.SQLInt(14)},
			{"sql_extract_expr_7", "EXTRACT(SECOND FROM TIMESTAMP '2006-04-07 07:14:23')", evaluator.SQLInt(23)},
			{"sql_extract_expr_8", "EXTRACT(MICROSECOND FROM TIMESTAMP '2006-04-07 07:14:23')", evaluator.SQLInt(0)},
			{"sql_extract_expr_9", "EXTRACT(YEAR_MONTH FROM TIMESTAMP '2006-04-07 07:14:23')", evaluator.SQLInt(200604)},
			{"sql_extract_expr_10", "EXTRACT(DAY_HOUR FROM TIMESTAMP '2006-04-07 07:14:23')", evaluator.SQLInt(707)},
			{"sql_extract_expr_11", "EXTRACT(DAY_MINUTE FROM TIMESTAMP '2006-04-07 07:14:23')", evaluator.SQLInt(70714)},
			{"sql_extract_expr_12", "EXTRACT(DAY_SECOND FROM TIMESTAMP '2006-04-07 07:14:23')", evaluator.SQLInt(7071423)},
			{"sql_extract_expr_13", "EXTRACT(DAY_MICROSECOND FROM TIMESTAMP '2006-04-07 07:14:23')", evaluator.SQLInt(7071423000000)},
			{"sql_extract_expr_14", "EXTRACT(HOUR_MINUTE FROM TIMESTAMP '2006-04-07 07:14:23')", evaluator.SQLInt(714)},
			{"sql_extract_expr_15", "EXTRACT(HOUR_SECOND FROM TIMESTAMP '2006-04-07 07:14:23')", evaluator.SQLInt(71423)},
			{"sql_extract_expr_16", "EXTRACT(HOUR_MICROSECOND FROM TIMESTAMP '2006-04-07 07:14:23')", evaluator.SQLInt(71423000000)},
			{"sql_extract_expr_17", "EXTRACT(MINUTE_SECOND FROM TIMESTAMP '2006-04-07 07:14:23')", evaluator.SQLInt(1423)},
			{"sql_extract_expr_18", "EXTRACT(MINUTE_MICROSECOND FROM TIMESTAMP '2006-04-07 07:14:23')", evaluator.SQLInt(1423000000)},
			{"sql_extract_expr_19", "EXTRACT(SECOND_MICROSECOND FROM TIMESTAMP '2006-04-07 07:14:23')", evaluator.SQLInt(23000000)},
			{"sql_extract_expr_20", "EXTRACT(SQL_TSI_MINUTE FROM TIMESTAMP '2006-04-07 07:14:23')", evaluator.SQLInt(14)},
			...
			{"sql_from_unixtime_2", "FROM_UNIXTIME(1447430881) + 0", evaluator.SQLDecimal128(decimal.New(20151113160801, 0))},
			{"sql_from_unixtime_3", "FROM_UNIXTIME(1447430881.5) + 0", evaluator.SQLDecimal128(decimal.New(20151113160802, 0))},
			{"sql_from_unixtime_4", "CONCAT(FROM_UNIXTIME(1447430881), '')", evaluator.SQLVarchar("2015-11-13 16:08:01.000000")},
			{"sql_from_unixtime_5", "CONCAT(FROM_UNIXTIME(1447430881.5), '')", evaluator.SQLVarchar("2015-11-13 16:08:02.000000")},
			...
			{"sql_if_expr_15", "IF(current_timestamp(), 4, 5)", evaluator.SQLInt(4)}, // not being parsed as dates, being parsed as string
			...
			{"sql_insert_expr_1", "INSERT('Quadratic', 3, 4, 'What')", evaluator.SQLVarchar("QuWhattic")},
			{"sql_insert_expr_2", "INSERT('Quadratic', -1, 4, 'What')", evaluator.SQLVarchar("Quadratic")},
			{"sql_insert_expr_3", "INSERT('Quadratic', 3, 100, 'What')", evaluator.SQLVarchar("QuWhat")},
			{"sql_insert_expr_4", "INSERT('Quadratic', 9, 4, 'What')", evaluator.SQLVarchar("QuadratiWhat")},
			{"sql_insert_expr_5", "INSERT('Quadratic', 8.5, 3.5, 'What')", evaluator.SQLVarchar("QuadratiWhat")},
			{"sql_insert_expr_6", "INSERT('Quadratic', 8.4, 3.4, 'What')", evaluator.SQLVarchar("QuadratWhat")},
			...
			{"sql_md5_2", "MD5('testing')", evaluator.SQLVarchar("ae2b1fca515949e5d54fb22b8ed95575")},
			...
			{"sql_md5_6", "MD5('12:STR.002234')", evaluator.SQLVarchar("81d56d5aeb92a55298af2f091e86ab61")},
			{"sql_md5_7", "MD5(REPEAT('a', 30))", evaluator.SQLVarchar("59e794d45697b360e18ba972bada0123")},
			...
			{"sql_microsecond_15", "MICROSECOND('1978-9-22 1:58:59.0000104')", evaluator.SQLInt(10)},
			...
			{"sql_month_name_expr_2", "MONTHNAME('2016-1-01 10:23:52')", evaluator.SQLVarchar("January")},
			...
			{"sql_replace_2", "REPLACE('www.mysql.com', 'w', 'Ww')", evaluator.SQLVarchar("WwWwWw.mysql.com")},
			...
			{"sql_lpad_symbols_5", "LPAD('⅓ ⅔ † ‡ µ ¢ £', 8, 'x')", evaluator.SQLVarchar("⅓ ⅔ † ‡ ")},
			...
			{"sql_rpad_symbols_5", "RPAD('⅓ ⅔ † ‡ µ ¢ £', 8, 'x')", evaluator.SQLVarchar("⅓ ⅔ † ‡ ")},
			...
			{"sql_substring_31", "SUBSTRING('Quadratically' FROM 5)", evaluator.SQLVarchar("ratically")},
			{"sql_substring_32", "SUBSTRING('Quadratically' FROM  5 for 6)", evaluator.SQLVarchar("ratica")},
			{"sql_substring_33", "SUBSTRING('Quadratically' from 12 FOR 2)", evaluator.SQLVarchar("ly")},
			...
			{"sql_substring_40", "SUBSTR('Quadratically' FROM  5)", evaluator.SQLVarchar("ratically")},
			{"sql_substring_41", "SUBSTR('Quadratically' FROM  5 for 6)", evaluator.SQLVarchar("ratica")},
			...
			{"sql_substring_index_0", "SUBSTRING_INDEX('www.cmysql.com', '.', NULL)", evaluator.SQLNull},
			{"sql_substring_index_1", "SUBSTRING_INDEX('www.cmysql.com', '.', 0)", evaluator.SQLVarchar("")},
			{"sql_substring_index_2", "SUBSTRING_INDEX('www.cmysql.com', '.', 1)", evaluator.SQLVarchar("www")},
			{"sql_substring_index_3", "SUBSTRING_INDEX('www.cmysql.com', '.c', 1)", evaluator.SQLVarchar("www")},
			{"sql_substring_index_4", "SUBSTRING_INDEX('www.cmysql.com', '.', 2)", evaluator.SQLVarchar("www.cmysql")},
			{"sql_substring_index_5", "SUBSTRING_INDEX('www.cmysql.com', '.', 1000)", evaluator.SQLVarchar("www.cmysql.com")},
			{"sql_substring_index_6", "SUBSTRING_INDEX('www.cmysql.com', '.c', 2)", evaluator.SQLVarchar("www.cmysql")},
			{"sql_substring_index_7", "SUBSTRING_INDEX('www.cmysql.com', '.', -2)", evaluator.SQLVarchar("cmysql.com")},
			{"sql_substring_index_8", "SUBSTRING_INDEX('www.cmysql.com', '.', -1)", evaluator.SQLVarchar("com")},
			...
			{"sql_time_to_sec_12", "TIME_TO_SEC(CONCAT('48:2','4:59'))", evaluator.SQLFloat(174299)},
			...
			{"sql_time_to_sec_19", "TIME_TO_SEC('2004-07-09 10:17:35.238238')", evaluator.SQLFloat(37055)},
			...
			{"sql_timediff_2", "TIMEDIFF('2000:09:11 00:00:00', '2000:09:31 00:00:01:323211')", evaluator.SQLNull},
			{"sql_timediff_3", "TIMEDIFF('2008-12-31 23:59:59.000001','2008-12-31 23:59:58.000001')", evaluator.SQLVarchar("00:00:01")},
			{"sql_timediff_4", "TIMEDIFF('2000:11:11 00:00:00', '2000:11:11 10:00:00.000231')", evaluator.SQLVarchar("-10:00:00.000231")},
			{"sql_timediff_5", "TIMEDIFF('2000:01:01 00:00:00','2000:01:01 00:00:00.000001')", evaluator.SQLVarchar("-00:00:00.000001")},
			{"sql_timediff_6", "TIMEDIFF('2008-12-31 23:59:59.000001','2008-12-30 01:01:01.000002')", evaluator.SQLVarchar("46:58:57.999999")},
			{"sql_timestampdiff_0", "TIMESTAMPDIFF(YEAR, DATE '2001-01-02', DATE '2002-01-02')", evaluator.SQLInt(1)},
			{"sql_timestampdiff_1", "TIMESTAMPDIFF(YEAR, DATE '2002-01-02', DATE '2001-01-02')", evaluator.SQLInt(-1)},
			{"sql_timestampdiff_2", "TIMESTAMPDIFF(YEAR, DATE '2001-01-03', DATE '2002-01-02')", evaluator.SQLInt(0)},
			{"sql_timestampdiff_3", "TIMESTAMPDIFF(YEAR, DATE '2001-01-02', DATE '2002-01-03')", evaluator.SQLInt(1)},
			{"sql_timestampdiff_4", "TIMESTAMPDIFF(QUARTER, DATE '2002-04-02', DATE '2002-01-02')", evaluator.SQLInt(-1)},
			{"sql_timestampdiff_5", "TIMESTAMPDIFF(QUARTER, DATE '2002-01-02', DATE '2002-06-02')", evaluator.SQLInt(1)},
			{"sql_timestampdiff_6", "TIMESTAMPDIFF(QUARTER, DATE '2002-01-02', DATE '2002-07-02')", evaluator.SQLInt(2)},
			{"sql_timestampdiff_7", "TIMESTAMPDIFF(QUARTER, DATE '2002-07-02', DATE '2002-01-02')", evaluator.SQLInt(-2)},
			{"sql_timestampdiff_8", "TIMESTAMPDIFF(MONTH, DATE '2002-01-02', DATE '2002-02-01')", evaluator.SQLInt(0)},
			{"sql_timestampdiff_9", "TIMESTAMPDIFF(MONTH, DATE '2002-02-01', DATE '2001-01-02')", evaluator.SQLInt(-12)},
			{"sql_timestampdiff_10", "TIMESTAMPDIFF(MONTH, DATE '2002-01-02', DATE '2002-02-02')", evaluator.SQLInt(1)},
			{"sql_timestampdiff_11", "TIMESTAMPDIFF(MONTH, DATE '2002-02-03', DATE '2002-01-02')", evaluator.SQLInt(-1)},
			{"sql_timestampdiff_12", "TIMESTAMPDIFF(WEEK, DATE '2001-01-02', DATE '2001-01-16')", evaluator.SQLInt(2)},
			{"sql_timestampdiff_13", "TIMESTAMPDIFF(WEEK, DATE '2001-01-02', DATE '2001-01-15')", evaluator.SQLInt(1)},
			{"sql_timestampdiff_14", "TIMESTAMPDIFF(WEEK, DATE '2001-01-15', DATE '2001-01-02')", evaluator.SQLInt(-1)},
			{"sql_timestampdiff_15", "TIMESTAMPDIFF(WEEK, DATE '2001-01-02', DATE '2001-01-17')", evaluator.SQLInt(2)},
			{"sql_timestampdiff_16", "TIMESTAMPDIFF(DAY, DATE '2003-01-04', DATE '2003-01-16')", evaluator.SQLInt(12)},
			{"sql_timestampdiff_17", "TIMESTAMPDIFF(DAY, DATE '2003-01-16', DATE '2003-01-04')", evaluator.SQLInt(-12)},
			{"sql_timestampdiff_18", "TIMESTAMPDIFF(HOUR, DATE '2003-01-04', DATE '2003-01-06')", evaluator.SQLInt(48)},
			{"sql_timestampdiff_19", "TIMESTAMPDIFF(MINUTE, DATE '2003-01-04', DATE '2003-01-06')", evaluator.SQLInt(2880)},
			{"sql_timestampdiff_20", "TIMESTAMPDIFF(SECOND, DATE '2003-01-04', DATE '2003-01-05')", evaluator.SQLInt(86400)},
			{"sql_timestampdiff_21", "TIMESTAMPDIFF(MICROSECOND, DATE '2003-01-04', DATE '2003-01-05')", evaluator.SQLInt(86400000000)},
			{"sql_timestampdiff_22", "TIMESTAMPDIFF(MICROSECOND, TIMESTAMP '2002-01-01 12:30:09', TIMESTAMP '2002-01-02 13:40:33')", evaluator.SQLInt(90624000000)},
			{"sql_timestampdiff_23", "TIMESTAMPDIFF(SQL_TSI_YEAR, TIMESTAMP '2002-01-02 12:30:09', TIMESTAMP '2003-03-04 12:45:30')", evaluator.SQLInt(1)},
			{"sql_timestampdiff_24", "TIMESTAMPDIFF(SQL_TSI_YEAR, TIMESTAMP '2002-01-02 12:30:09', TIMESTAMP '2002-03-04 12:45:30')", evaluator.SQLInt(0)},
			{"sql_timestampdiff_25", "TIMESTAMPDIFF(SQL_TSI_YEAR, TIMESTAMP '2002-03-04 12:45:30', TIMESTAMP '2002-01-02 12:30:09')", evaluator.SQLInt(0)},
			{"sql_timestampdiff_26", "TIMESTAMPDIFF(SQL_TSI_YEAR, TIMESTAMP '2003-03-04 12:30:06', DATE '2002-03-04')", evaluator.SQLInt(-1)},
			{"sql_timestampdiff_27", "TIMESTAMPDIFF(SQL_TSI_YEAR, DATE '2004-03-04', TIMESTAMP '2003-03-04 12:30:06')", evaluator.SQLInt(0)},
			{"sql_timestampdiff_28", "TIMESTAMPDIFF(SQL_TSI_QUARTER, DATE '2002-01-01', TIMESTAMP '2002-04-01 12:30:06')", evaluator.SQLInt(1)},
			{"sql_timestampdiff_29", "TIMESTAMPDIFF(SQL_TSI_QUARTER, TIMESTAMP '2002-04-01 12:30:06', DATE '2002-01-01')", evaluator.SQLInt(-1)},
			{"sql_timestampdiff_30", "TIMESTAMPDIFF(SQL_TSI_QUARTER, TIMESTAMP '2002-01-01 12:30:06', DATE '2002-04-01')", evaluator.SQLInt(0)},
			{"sql_timestampdiff_31", "TIMESTAMPDIFF(SQL_TSI_QUARTER, DATE '2002-04-01', TIMESTAMP '2002-01-01 12:30:06')", evaluator.SQLInt(0)},
			{"sql_timestampdiff_32", "TIMESTAMPDIFF(SQL_TSI_MONTH, DATE '2002-01-01', TIMESTAMP '2002-03-01 12:30:09')", evaluator.SQLInt(2)},
			{"sql_timestampdiff_33", "TIMESTAMPDIFF(SQL_TSI_MONTH, TIMESTAMP '2002-03-01 12:30:09', DATE '2002-01-01')", evaluator.SQLInt(-2)},
			{"sql_timestampdiff_34", "TIMESTAMPDIFF(SQL_TSI_MONTH, TIMESTAMP '2002-01-01 12:30:09', DATE '2002-03-01')", evaluator.SQLInt(1)},
			{"sql_timestampdiff_35", "TIMESTAMPDIFF(SQL_TSI_MONTH, DATE '2002-03-01', TIMESTAMP '2002-01-01 12:30:09')", evaluator.SQLInt(-1)},
			{"sql_timestampdiff_36", "TIMESTAMPDIFF(SQL_TSI_WEEK, TIMESTAMP '2002-01-01 12:30:09', DATE '2002-01-08')", evaluator.SQLInt(0)},
			{"sql_timestampdiff_37", "TIMESTAMPDIFF(SQL_TSI_WEEK, DATE '2002-01-01', TIMESTAMP '2002-01-08 12:30:09')", evaluator.SQLInt(1)},
			{"sql_timestampdiff_38", "TIMESTAMPDIFF(SQL_TSI_WEEK, TIMESTAMP '2002-01-08 12:30:09', DATE '2002-01-01')", evaluator.SQLInt(-1)},
			{"sql_timestampdiff_39", "TIMESTAMPDIFF(SQL_TSI_DAY, DATE '2002-01-01', TIMESTAMP '2002-01-02 12:30:09')", evaluator.SQLInt(1)},
			{"sql_timestampdiff_40", "TIMESTAMPDIFF(SQL_TSI_DAY, TIMESTAMP '2002-01-02 12:30:09', DATE '2002-01-01')", evaluator.SQLInt(-1)},
			{"sql_timestampdiff_41", "TIMESTAMPDIFF(SQL_TSI_DAY, TIMESTAMP '2002-01-01 12:30:09', DATE '2002-01-02')", evaluator.SQLInt(0)},
			{"sql_timestampdiff_42", "TIMESTAMPDIFF(SQL_TSI_HOUR, TIMESTAMP '2002-01-01 12:30:09', DATE '2002-01-02')", evaluator.SQLInt(11)},
			{"sql_timestampdiff_43", "TIMESTAMPDIFF(SQL_TSI_HOUR, TIMESTAMP '2002-01-01 12:30:09', TIMESTAMP '2002-01-02 11:02:33')", evaluator.SQLInt(22)},
			{"sql_timestampdiff_44", "TIMESTAMPDIFF(SQL_TSI_MINUTE, TIMESTAMP '2002-01-01 12:30:09', TIMESTAMP '2002-01-01 13:02:33')", evaluator.SQLInt(32)},
			{"sql_timestampdiff_45", "TIMESTAMPDIFF(SQL_TSI_MINUTE, TIMESTAMP '2002-01-01 12:30:09', DATE '2002-01-02')", evaluator.SQLInt(689)},
			{"sql_timestampdiff_46", "TIMESTAMPDIFF(SQL_TSI_SECOND, TIMESTAMP '2002-01-01 12:30:09', TIMESTAMP '2002-01-02 14:40:33')", evaluator.SQLInt(94224)},
			...
			{"sql_to_seconds_14", "TO_SECONDS('2000-09-23 13:45:00')", evaluator.SQLInt(63136935900)},
			{"sql_to_seconds_15", "TO_SECONDS('2000-09-24 13:45:00')", evaluator.SQLInt(63137022300)},
			{"sql_to_seconds_16", "TO_SECONDS('2000-10-24 13:45:00')", evaluator.SQLInt(63139614300)},
			{"sql_to_seconds_17", "TO_SECONDS('2000-10-24 15:45:00')", evaluator.SQLInt(63139621500)},
			{"sql_to_seconds_18", "TO_SECONDS('2000-10-24 13:47:00')", evaluator.SQLInt(63139614420)},
			{"sql_to_seconds_19", "TO_SECONDS('2000-10-24 13:45:59')", evaluator.SQLInt(63139614359)},
			...
			{"sql_trim_3", "TRIM(LEADING 'xyz' FROM 'xyzbarxyzxyz')", evaluator.SQLVarchar("barxyzxyz")},
			{"sql_trim_4", "TRIM(TRAILING 'xyz' FROM 'xyzbarxyzxyz')", evaluator.SQLVarchar("xyzbar")},
			...
			/*
				...
				test{"sql_unix_timestamp_2", "UNIX_TIMESTAMP('2015-11-13 10:20:19')", SQLUint64(1447428019)},
				test{"sql_unix_timestamp_3", "UNIX_TIMESTAMP('2017-03-27 03:00:00')", SQLUint64(1490598000)},
				test{"sql_unix_timestamp_4", "UNIX_TIMESTAMP('2012-11-17 12:00:00')", SQLUint64(1353171600)},
			...
			*/
			...
			{"sql_unary_minus_7", "- timestamp '2005-05-11 12:22:04'", evaluator.SQLInt(-20050511122204)},
		...
		typeTests := []typeTest{
			...
			{"sql_convert_type_4", "CONVERT(TIMESTAMP '2006-05-11 12:32:12', DATETIME)", schema.SQLTimestamp},
			{"sql_convert_type_5", "CONVERT(DATE '2006-05-11', SQL_TIMESTAMP)", schema.SQLTimestamp},
			{"sql_date_add_type_0", "DATE_ADD('2002-01-02', INTERVAL 1 YEAR)", schema.SQLTimestamp},
			{"sql_date_add_type_1", "DATE_ADD(DATE '2002-01-02', INTERVAL 1 HOUR)", schema.SQLTimestamp},
			{"sql_date_add_type_2", "DATE_ADD(TIMESTAMP '2003-01-02 10:28:06', INTERVAL '2 2:3' DAY_SECOND)", schema.SQLTimestamp},
			{"sql_date_sub_type_0", "DATE_SUB('2002-01-02', INTERVAL 1 YEAR)", schema.SQLTimestamp},
			{"sql_date_sub_type_1", "DATE_SUB(DATE '2002-01-02', INTERVAL 1 HOUR)", schema.SQLTimestamp},
			{"sql_date_sub_type_2", "DATE_SUB(TIMESTAMP '2003-01-02 10:28:06', INTERVAL '2 2:3' DAY_SECOND)", schema.SQLTimestamp},
			{"sql_greatest_type_0", "GREATEST(DATE '2005-05-11', DATE '2006-05-11', DATE '2000-05-11')", schema.SQLDate},
			...
			{"sql_least_type_0", "LEAST(DATE '2005-05-11', DATE '2006-05-11', DATE '2000-05-11')", schema.SQLDate},
			{"sql_least_type_1", "LEAST(1, 123.52, 'something')", schema.SQLDecimal128},
			{"sql_timestampadd_type_0", "TIMESTAMPADD(SQL_TSI_QUARTER, 2, DATE '2002-07-02')", schema.SQLTimestamp},
			{"sql_timestampadd_type_1", "TIMESTAMPADD(SQL_TSI_SECOND, 1, TIMESTAMP '2003-01-02 12:30:08')", schema.SQLTimestamp},
		}
		...
		t.Run("sql_assignment_expr", func(t *testing.T) {
			...
			req.Equal(result, evaluator.SQLInt(4), "expected value of assignment does not match actual value")
		})
		...
		t.Run("subject: sqlcolumnexpr", func(t *testing.T) {
			t.Run("should return the value of the field when it exists", func(t *testing.T) {
				...
				req.Equal(result, evaluator.SQLInt(123), "actual value of evaluated expression does not match expected value")
			})
			...
			t.Run("should return nil when the field is null", func(t *testing.T) {
				...
				result, err := subject.Evaluate(evalCtx)
				req.Nil(err, "unable to evalute sql expression")
				req.IsType(evaluator.SQLNull, result, "actual type does not match expected type of evaluated expression")
			})
		...
		t.Run("subject: date", func(t *testing.T) {
			...
			tests = []test{
				{"sql_date_parse_comparison_0", "DATE '2014-04-13'", evaluator.SQLDate{Time: dateTime0}},
				{"sql_date_parse_comparison_1", "{d '2014-04-13'}", evaluator.SQLDate{Time: dateTime0}},
				{"sql_date_parse_comparison_2", "TIME '11:49:36'", evaluator.SQLTimestamp{Time: dateTime1}},
				{"sql_date_parse_comparison_3", "{t '11:49:36'}", evaluator.SQLTimestamp{Time: dateTime1}},
				{"sql_timestamp_parse_0", "TIMESTAMP '1997-01-31 09:26:50.124'", evaluator.SQLTimestamp{Time: dateTime2}},
				{"sql_timestamp_parse_1", "{ts '1997-01-31 09:26:50.124'}", evaluator.SQLTimestamp{Time: dateTime2}},
			}
			runTests(t, evalCtx, tests)
		})
		...
		t.Run("subject: adddate", func(t *testing.T) {
			...
			tests := []test{
				...
				{"sql_add_date_1", "ADDDATE('2002-01-02', INTERVAL 1 YEAR)", evaluator.SQLTimestamp{Time: d}},
				{"sql_add_date_2", "ADDDATE('2003-08-31', INTERVAL 1 QUARTER)", evaluator.SQLTimestamp{Time: d2}},
				{"sql_add_date_3", "ADDDATE('2003-10-31', INTERVAL 1 MONTH)", evaluator.SQLTimestamp{Time: d2}},
				{"sql_add_date_4", "ADDDATE('2003-01-01', INTERVAL 1 DAY)", evaluator.SQLTimestamp{Time: d}},
				{"sql_add_date_5", "ADDDATE('2003-01-02 14:30:09', INTERVAL -2 HOUR)", evaluator.SQLTimestamp{Time: t1}},
				{"sql_add_date_6", "ADDDATE('2003-01-02 12:23:09', INTERVAL 7 MINUTE)", evaluator.SQLTimestamp{Time: t1}},
				{"sql_add_date_7", "ADDDATE('2003-01-02 12:30:12', INTERVAL -3 SECOND)", evaluator.SQLTimestamp{Time: t1}},
				{"sql_add_date_8", "ADDDATE('2003-01-02 12:32:10', INTERVAL '-2:1' MINUTE_SECOND)", evaluator.SQLTimestamp{Time: t1}},
				{"sql_add_date_9", "ADDDATE('2003-01-02 05:27:06', INTERVAL '7:3:3' HOUR_SECOND)", evaluator.SQLTimestamp{Time: t1}},
				{"sql_add_date_10", "ADDDATE('2003-01-02 15:32:09', INTERVAL '-3:2' HOUR_MINUTE)", evaluator.SQLTimestamp{Time: t1}},
				{"sql_add_date_11", "ADDDATE('2002-12-31 10:27:05', INTERVAL '2 2:3:4' DAY_SECOND)", evaluator.SQLTimestamp{Time: t1}},
				{"sql_add_date_12", "ADDDATE('2002-12-31 10:27:09', INTERVAL '2 2:3' DAY_MINUTE)", evaluator.SQLTimestamp{Time: t1}},
				{"sql_add_date_13", "ADDDATE('2003-01-01 08:30:09', INTERVAL '1 4' DAY_HOUR)", evaluator.SQLTimestamp{Time: t1}},
				{"sql_add_date_14", "ADDDATE('2000-09-02 12:30:09', INTERVAL '2-4' YEAR_MONTH)", evaluator.SQLTimestamp{Time: t1}},
				{"sql_add_date_15", "ADDDATE('2003-01-02 12:33:09', INTERVAL '-3' HOUR_MINUTE)", evaluator.SQLTimestamp{Time: t1}},
				{"sql_add_date_16", "ADDDATE('2003-01-02 10:28:06', INTERVAL '2 2:3' DAY_SECOND)", evaluator.SQLTimestamp{Time: t1}},
				{"sql_add_date_17", "ADDDATE('2003-01-02 10:28:06', 32)", evaluator.SQLTimestamp{Time: t2}},
				{"sql_add_date_18", "ADDDATE('2003-01-02 10:28:06', 43)", evaluator.SQLTimestamp{Time: t3}},
				{"sql_add_date_19", "ADDDATE('2003-01-02 10:28:06.000', 43)", evaluator.SQLTimestamp{Time: t3}},
				{"sql_add_date_20", "ADDDATE('2003-01-02 10:28:06.000000', 43)", evaluator.SQLTimestamp{Time: t3}},
		...
		t.Run("subject: convert", func(t *testing.T) {
			...
			tests := []test{
				...
				{"sql_convert_expr_68", "CONVERT(DATE '2006-05-11', DATE)", evaluator.SQLDate{Time: d}},
				{"sql_convert_expr_69", "CONVERT(TIMESTAMP '2006-05-11 12:32:12', DATE)", evaluator.SQLDate{Time: d}},
				...
				{"sql_convert_expr_73", "CONVERT('2006-05-11', DATETIME)", evaluator.SQLTimestamp{Time: dt}},
				{"sql_convert_expr_74", "CONVERT(true, DATETIME)", evaluator.SQLNull},
				{"sql_convert_expr_75", "CONVERT(3, SQL_TIMESTAMP)", evaluator.SQLNull},
				{"sql_convert_expr_76", "CONVERT(TIMESTAMP '2006-05-11 12:32:12', DATETIME)", evaluator.SQLTimestamp{Time: t1}},
				{"sql_convert_expr_77", "CONVERT(DATE '2006-05-11', SQL_TIMESTAMP)", evaluator.SQLTimestamp{Time: dt}},
				{"sql_convert_expr_78", "CONVERT('12:32:12', TIME)", evaluator.SQLTimestamp{Time: time.Date(0, 1, 1, 12, 32, 12, 0, time.UTC)}},
				{"sql_convert_expr_79", "CONVERT('2006-04-11 12:32:12', TIME)", evaluator.SQLTimestamp{Time: time.Date(0, 1, 1, 0, 0, 0, 0, time.UTC)}},
			}
			runTests(t, evalCtx, tests)
		})
		...
		t.Run("subject: date", func(t *testing.T) {
			...
			tests := []test{
				...
				{"sql_date_padded_nums_7", "DATE(61110123025.22)", evaluator.SQLDate{Time: nov102006}},
				{"sql_date_padded_nums_8", "DATE(1161110123025)", evaluator.SQLDate{Time: nov100116}},
		...
		t.Run("subject: date_add", func(t *testing.T) {
			...
			tests := []test{
				{"sql_date_add_0", "DATE_ADD('2002-12-31 10:27:04.500000', INTERVAL '2 2:3:4.5' DAY_MICROSECOND)", evaluator.SQLTimestamp{Time: t0}},

				{"sql_date_add_1", "DATE_ADD('2003-01-02 10:28:05.500000', INTERVAL '2:2:3.5' DAY_MICROSECOND)", evaluator.SQLTimestamp{Time: t0}},
				{"sql_date_add_2", "DATE_ADD('2003-01-02 10:28:05.500000', INTERVAL '2:2:3.5' HOUR_MICROSECOND)", evaluator.SQLTimestamp{Time: t0}},
				{"sql_date_add_3", "DATE_ADD('2002-12-31 10:27:05', INTERVAL '2 2:3:4' DAY_SECOND)", evaluator.SQLTimestamp{Time: t0}},

				{"sql_date_add_4", "DATE_ADD('2003-01-02 12:27:04.500000', INTERVAL '3:4.5' DAY_MICROSECOND)", evaluator.SQLTimestamp{Time: t0}},
				{"sql_date_add_5", "DATE_ADD('2003-01-02 12:27:04.500000', INTERVAL '3:4.5' HOUR_MICROSECOND)", evaluator.SQLTimestamp{Time: t0}},
				{"sql_date_add_6", "DATE_ADD('2003-01-02 12:27:04.500000', INTERVAL '3:4.5' MINUTE_MICROSECOND)", evaluator.SQLTimestamp{Time: t0}},
				{"sql_date_add_7", "DATE_ADD('2003-01-02 10:27:05', INTERVAL '2:3:4' DAY_SECOND)", evaluator.SQLTimestamp{Time: t0}},
				{"sql_date_add_8", "DATE_ADD('2003-01-02 10:27:05', INTERVAL '2:3:4' HOUR_SECOND)", evaluator.SQLTimestamp{Time: t0}},
				{"sql_date_add_9", "DATE_ADD('2002-12-31 10:27:09', INTERVAL '2 2:3' DAY_MINUTE)", evaluator.SQLTimestamp{Time: t0}},

				{"sql_date_add_10", "DATE_ADD('2003-01-02 12:30:04.500000', INTERVAL '4.5' DAY_MICROSECOND)", evaluator.SQLTimestamp{Time: t0}},
				{"sql_date_add_11", "DATE_ADD('2003-01-02 12:30:04.500000', INTERVAL '4.5' HOUR_MICROSECOND)", evaluator.SQLTimestamp{Time: t0}},
				{"sql_date_add_12", "DATE_ADD('2003-01-02 12:30:04.500000', INTERVAL '4.5' MINUTE_MICROSECOND)", evaluator.SQLTimestamp{Time: t0}},
				{"sql_date_add_13", "DATE_ADD('2003-01-02 12:30:04.500000', INTERVAL '4.5' SECOND_MICROSECOND)", evaluator.SQLTimestamp{Time: t0}},
				{"sql_date_add_14", "DATE_ADD('2003-01-02 12:32:10', INTERVAL '-2:1' DAY_SECOND)", evaluator.SQLTimestamp{Time: t0}},
				{"sql_date_add_15", "DATE_ADD('2003-01-02 12:32:10', INTERVAL '-2:1' HOUR_SECOND)", evaluator.SQLTimestamp{Time: t0}},
				{"sql_date_add_16", "DATE_ADD('2003-01-02 12:32:10', INTERVAL '-2:1' MINUTE_SECOND)", evaluator.SQLTimestamp{Time: t0}},
				{"sql_date_add_17", "DATE_ADD('2003-01-02 15:32:09', INTERVAL '-3:2' DAY_MINUTE)", evaluator.SQLTimestamp{Time: t0}},
				{"sql_date_add_18", "DATE_ADD('2003-01-02 15:32:09', INTERVAL '-3:2' HOUR_MINUTE)", evaluator.SQLTimestamp{Time: t0}},
				{"sql_date_add_19", "DATE_ADD('2002-12-31 10:30:09', INTERVAL '2 2' DAY_HOUR)", evaluator.SQLTimestamp{Time: t0}},
				{"sql_date_add_20", "DATE_ADD('2000-09-02 12:30:09', INTERVAL '2-4' YEAR_MONTH)", evaluator.SQLTimestamp{Time: t0}},

				{"sql_date_add_21", "DATE_ADD('2002-01-02', INTERVAL NULL YEAR)", evaluator.SQLNull},
				{"sql_date_add_22", "DATE_ADD(NULL, INTERVAL 1 YEAR)", evaluator.SQLNull},
				{"sql_date_add_23", "DATE_ADD('2002-01-02', INTERVAL 1 YEAR)", evaluator.SQLTimestamp{Time: d}},
				{"sql_date_add_24", "DATE_ADD('2003-08-31', INTERVAL 1 QUARTER)", evaluator.SQLTimestamp{Time: d2}},
				{"sql_date_add_25", "DATE_ADD('2003-10-31', INTERVAL 1 MONTH)", evaluator.SQLTimestamp{Time: d2}},
				{"sql_date_add_26", "DATE_ADD('2003-01-01', INTERVAL 1 DAY)", evaluator.SQLTimestamp{Time: d}},
				{"sql_date_add_27", "DATE_ADD('2003-01-02 14:30:09', INTERVAL -2 HOUR)", evaluator.SQLTimestamp{Time: t0}},
				{"sql_date_add_28", "DATE_ADD('2003-01-02 12:23:09', INTERVAL 7 MINUTE)", evaluator.SQLTimestamp{Time: t0}},
				{"sql_date_add_29", "DATE_ADD('2003-01-02 12:30:12', INTERVAL -3 SECOND)", evaluator.SQLTimestamp{Time: t0}},
				{"sql_date_add_30", "DATE_ADD('2003-01-02 12:30:08.999999', INTERVAL 1 MICROSECOND)", evaluator.SQLTimestamp{Time: t0}},
			}
			runTests(t, evalCtx, tests)
		})
		...
		t.Run("subject: date_sub, subdate", func(t *testing.T) {
			...
			tests := []test{
				...
				{"sql_date_sub_2", "DATE_SUB('2004-01-02', INTERVAL 1 YEAR)", evaluator.SQLTimestamp{Time: d}},
				{"sql_date_sub_3", "DATE_SUB('2003-04-02', INTERVAL 1 QUARTER)", evaluator.SQLTimestamp{Time: d}},
				{"sql_date_sub_4", "DATE_SUB('2003-12-31', INTERVAL 1 MONTH)", evaluator.SQLTimestamp{Time: d2}},
				{"sql_date_sub_5", "DATE_SUB('2003-01-03', INTERVAL 1 DAY)", evaluator.SQLTimestamp{Time: d}},
				{"sql_date_sub_6", "SUBDATE('2004-01-02', INTERVAL 1 YEAR)", evaluator.SQLTimestamp{Time: d}},
				{"sql_date_sub_7", "SUBDATE('2003-04-02', INTERVAL 1 QUARTER)", evaluator.SQLTimestamp{Time: d}},
				{"sql_date_sub_8", "SUBDATE('2003-12-31', INTERVAL 1 MONTH)", evaluator.SQLTimestamp{Time: d2}},
				{"sql_date_sub_9", "SUBDATE('2008-01-02 12:00:00', 31)", evaluator.SQLTimestamp{Time: t2}},
				{"sql_date_sub_10", "SUBDATE('2016-01-02 12:00:00', 2953)", evaluator.SQLTimestamp{Time: t2}},
				{"sql_date_sub_11", "DATE_SUB('2003-01-02 10:30:09', INTERVAL -2 HOUR)", evaluator.SQLTimestamp{Time: t1}},
				{"sql_date_sub_12", "DATE_SUB('2003-01-02 12:37:09', INTERVAL 7 MINUTE)", evaluator.SQLTimestamp{Time: t1}},
				{"sql_date_sub_13", "DATE_SUB('2003-01-02 12:30:12', INTERVAL 3 SECOND)", evaluator.SQLTimestamp{Time: t1}},
				{"sql_date_sub_14", "DATE_SUB('2003-01-02 12:32:10', INTERVAL '2:1' MINUTE_SECOND)", evaluator.SQLTimestamp{Time: t1}},
				{"sql_date_sub_15", "DATE_SUB('2003-01-02 19:33:12', INTERVAL '7:3:3' HOUR_SECOND)", evaluator.SQLTimestamp{Time: t1}},
				{"sql_date_sub_16", "DATE_SUB('2003-01-02 15:32:09', INTERVAL '3:2' HOUR_MINUTE)", evaluator.SQLTimestamp{Time: t1}},
				{"sql_date_sub_17", "DATE_SUB('2003-01-04 14:33:13', INTERVAL '2 2:3:4' DAY_SECOND)", evaluator.SQLTimestamp{Time: t1}},
				{"sql_date_sub_18", "DATE_SUB('2003-01-04 14:33:09', INTERVAL '2 2:3' DAY_MINUTE)", evaluator.SQLTimestamp{Time: t1}},
				{"sql_date_sub_19", "DATE_SUB('2003-01-03 16:30:09', INTERVAL '1 4' DAY_HOUR)", evaluator.SQLTimestamp{Time: t1}},
				{"sql_date_sub_20", "DATE_SUB('2005-05-02 12:30:09', INTERVAL '2-4' YEAR_MONTH)", evaluator.SQLTimestamp{Time: t1}},
				{"sql_date_sub_21", "DATE_SUB('2003-01-02 12:33:09', INTERVAL '3' HOUR_MINUTE)", evaluator.SQLTimestamp{Time: t1}},
				{"sql_date_sub_22", "DATE_SUB('2003-01-02 14:32:12', INTERVAL '2 2:3' DAY_SECOND)", evaluator.SQLTimestamp{Time: t1}},
			}
			runTests(t, evalCtx, tests)
		})
		...
		t.Run("subject: greatest", func(t *testing.T) {
			...
			tests := []test{
				...
				{"sql_greatest_expr_2", "GREATEST(2,2.3)", evaluator.SQLDecimal128(decimal.New(23, -1))},
				{"sql_greatest_expr_3", "GREATEST('cats', '4', '2')", evaluator.SQLVarchar("cats")},
				{"sql_greatest_expr_4", "GREATEST('dog', 'cats', 'bird')", evaluator.SQLVarchar("dog")},
				{"sql_greatest_expr_5", "GREATEST('cat', 'bird', 2)", evaluator.SQLInt(2)},
				{"sql_greatest_expr_6", "GREATEST('cat', 2.2)", evaluator.SQLDecimal128(decimal.New(22, -1))},
				{"sql_greatest_expr_7", "GREATEST(false, true)", evaluator.SQLTrue},
				{"sql_greatest_expr_8", "GREATEST(DATE '2005-05-11', DATE '2006-05-11', DATE '2000-05-11')", evaluator.SQLDate{Time: d}},
				{"sql_greatest_expr_9", "GREATEST(DATE '2006-05-11', 14, 4235)", evaluator.SQLInt(20060511)},
				{"sql_greatest_expr_10", "GREATEST(DATE '2006-05-11', 14, 20080622)", evaluator.SQLInt(20080622)},
				{"sql_greatest_expr_11", "GREATEST(DATE '2006-05-11', 14, 20080622.1)", evaluator.SQLDecimal128(decimal.New(200806221, -1))},
				{"sql_greatest_expr_12", "GREATEST(DATE '2006-05-11', 14, 4235.2)", evaluator.SQLDecimal128(decimal.New(20060511, 0))},
				{"sql_greatest_expr_13", "GREATEST(TIMESTAMP '2006-05-11 12:32:23', DATE '2006-05-11')", evaluator.SQLTimestamp{Time: t0}},
				{"sql_greatest_expr_14", "GREATEST(TIMESTAMP '2006-05-11 12:32:23', 12, 345)", evaluator.SQLInt(20060511123223)},
				{"sql_greatest_expr_15", "GREATEST(TIMESTAMP '2006-05-11 12:32:23', 20080923124345.3)", evaluator.SQLDecimal128(decimal.New(200809231243453, -1))},
				{"sql_greatest_expr_16", "GREATEST(DATE '2006-05-11', 'cat', '2007-04-11')", evaluator.SQLVarchar("2007-04-11")},
				{"sql_greatest_expr_17", "GREATEST(DATE '2006-05-11', 20080912, '2007-04-11')", evaluator.SQLInt(20080912)},
				{"sql_greatest_expr_18", "GREATEST(TIMESTAMP '2006-05-11 12:32:23', TIMESTAMP '2006-05-11 10:32:45')", evaluator.SQLTimestamp{Time: t0}},
				{"sql_greatest_expr_19", "GREATEST(TIMESTAMP '2006-05-11 12:32:23', 20080913, DATE '2007-08-23')", evaluator.SQLInt(20060511123223)},
				{"sql_greatest_expr_20", "GREATEST(TIMESTAMP '2006-05-11 12:32:23', '2008-09-13')", evaluator.SQLVarchar("2008-09-13")},
				{"sql_greatest_expr_21", "GREATEST(TIMESTAMP '2006-05-11 12:32:23', '2005-09-13')", evaluator.SQLTimestamp{Time: t0}},
			}
			runTests(t, evalCtx, tests)
		})
		...
		t.Run("subject: least", func(t *testing.T) {
			...
			tests := []test{
				...
				{"sql_least_expr_6", "LEAST(DATE '2005-05-11', DATE '2006-05-11', DATE '2007-05-11')", evaluator.SQLDate{Time: d}},
				{"sql_least_expr_7", "LEAST(TIMESTAMP '2006-05-11 12:32:23', DATE '2006-05-11')", evaluator.SQLTimestamp{Time: t0}},
				{"sql_least_expr_8", "LEAST(TIMESTAMP '2006-05-11 12:32:23', TIMESTAMP '2006-05-11 10:32:23')", evaluator.SQLTimestamp{Time: t1}},
				...
				{"sql_least_expr_12", "LEAST(DATE '2006-05-11', 14, 20080622.1)", evaluator.SQLDecimal128(decimal.New(14, 0))},
				{"sql_least_expr_13", "LEAST(DATE '2006-05-11', 14, 4235.2)", evaluator.SQLDecimal128(decimal.New(14, 0))},
				{"sql_least_expr_14", "LEAST(TIMESTAMP '2006-05-11 12:32:23', 12, 345)", evaluator.SQLInt(12)},
				{"sql_least_expr_15", "LEAST(TIMESTAMP '2006-05-11 12:32:23', 20080923124345.3)", evaluator.SQLDecimal128(decimal.New(20060511123223, 0))},
				{"sql_least_expr_16", "LEAST(DATE '2006-05-11', 'cat', '2007-04-11')", evaluator.SQLVarchar("cat")},
				{"sql_least_expr_17", "LEAST(DATE '2006-05-11', 20080912, '2007-04-11')", evaluator.SQLInt(0)},
				{"sql_least_expr_18", "LEAST(TIMESTAMP '2006-05-11 12:32:23', 20080913, DATE '2007-08-23')", evaluator.SQLInt(20070823)},
				{"sql_least_expr_19", "LEAST(TIMESTAMP '2006-05-11 10:32:23', '2008-09-13')", evaluator.SQLTimestamp{Time: t1}},
				{"sql_least_expr_20", "LEAST(TIMESTAMP '2006-05-11 12:32:23', '2005-09-13')", evaluator.SQLVarchar("2005-09-13")},
			}
			runTests(t, evalCtx, tests)
		...
		t.Run("subject: str_to_date", func(t *testing.T) {
			...
			tests := []test{
				...
				{"sql_str_to_date_2", "STR_TO_DATE('2016-04-03','%Y-%m-%d')", evaluator.SQLDate{Time: d}},
				{"sql_str_to_date_3", "STR_TO_DATE('04,03,2016', '%m,%d,%Y')", evaluator.SQLDate{Time: d}},
				{"sql_str_to_date_4", "STR_TO_DATE('04,03,a16', '%m,%d,a%y')", evaluator.SQLDate{Time: d}},
				{"sql_str_to_date_5", "STR_TO_DATE('2016-04-03 12:22:22', '%Y-%m-%d %H:%i:%s')", evaluator.SQLTimestamp{Time: t0}},
				{"sql_str_to_date_6", "STR_TO_DATE('2016-04-03 12:22', '%Y-%m-%d %H:%i')", evaluator.SQLTimestamp{Time: t2}},
				{"sql_str_to_date_7", "STR_TO_DATE('2005-04-02 12', '%Y-%m-%d %i')", evaluator.SQLTimestamp{Time: t1}},
				{"sql_str_to_date_8", "STR_TO_DATE('Apr 03, 2016', '%b %d, %Y')", evaluator.SQLDate{Time: d}},
				{"sql_str_to_date_9", "STR_TO_DATE('Tue 2016-04-03', '%a %Y-%m-%d')", evaluator.SQLDate{Time: d}},
			}
			runTests(t, evalCtx, tests)
		})
		...
		t.Run("subject: timestamp", func(t *testing.T) {
			...
			tests := []test{
				...
				{"sql_timestamp_4", "TIMESTAMP('2010-01-01 11:11:11', '11:71:11')", evaluator.SQLNull},
				{"sql_timestamp_5", "TIMESTAMP('2010-01-01 11:11:11', '11:23:59.5232355')", evaluator.SQLTimestamp{Time: t1}},
				{"sql_timestamp_6", "TIMESTAMP('2010-01-01 11:11:11', '12:22.4:12')", evaluator.SQLTimestamp{Time: t2}},
				{"sql_timestamp_7", "TIMESTAMP('2003-12-31 12:00:00', '12:00:00')", evaluator.SQLTimestamp{Time: t3}},
				...
				{"sql_timestamp_10", "TIMESTAMP('2003-12-31 12:00:00', '12.3:10:30')", evaluator.SQLTimestamp{Time: t5}},
				{"sql_timestamp_11", "TIMESTAMP('2003-12-31 12:23:23')", evaluator.SQLTimestamp{Time: t6}},
				{"sql_timestamp_12", "TIMESTAMP('2010-01-01 11:11:11', '12212')", evaluator.SQLTimestamp{Time: t7}},
				{"sql_timestamp_13", "TIMESTAMP('2010-01-01 11:11:11', 12212)", evaluator.SQLTimestamp{Time: t7}},
			}
			runTests(t, evalCtx, tests)
		})
		...
		t.Run("subject: timestampadd", func(t *testing.T) {
			...
			tests := []test{
				{"sql_timestampadd_0", "TIMESTAMPADD(YEAR, 1, DATE '2002-01-02')", evaluator.SQLTimestamp{Time: d}},
				{"sql_timestampadd_1", "TIMESTAMPADD(YEAR, 0.5, DATE '2002-01-02')", evaluator.SQLTimestamp{Time: d}},
				{"sql_timestampadd_2", "TIMESTAMPADD(QUARTER, 1, DATE '2002-10-02')", evaluator.SQLTimestamp{Time: d}},
				{"sql_timestampadd_3", "TIMESTAMPADD(QUARTER, 0.5, DATE '2002-10-02')", evaluator.SQLTimestamp{Time: d}},
				{"sql_timestampadd_4", "TIMESTAMPADD(MONTH, 1, DATE '2002-12-02')", evaluator.SQLTimestamp{Time: d}},
				{"sql_timestampadd_5", "TIMESTAMPADD(MONTH, 0.5, DATE '2002-12-02')", evaluator.SQLTimestamp{Time: d}},
				{"sql_timestampadd_6", "TIMESTAMPADD(WEEK, 1, DATE '2002-12-26')", evaluator.SQLTimestamp{Time: d}},
				{"sql_timestampadd_7", "TIMESTAMPADD(WEEK, 0.5, DATE '2002-12-26')", evaluator.SQLTimestamp{Time: d}},
				{"sql_timestampadd_8", "TIMESTAMPADD(DAY, 1, DATE '2003-01-01')", evaluator.SQLTimestamp{Time: d}},
				{"sql_timestampadd_9", "TIMESTAMPADD(DAY, 0.5, DATE '2003-01-01')", evaluator.SQLTimestamp{Time: d}},
				{"sql_timestampadd_10", "TIMESTAMPADD(HOUR, 1, DATE '2003-01-02')", evaluator.SQLTimestamp{Time: dt}},
				{"sql_timestampadd_11", "TIMESTAMPADD(HOUR, 0.5, DATE '2003-01-02')", evaluator.SQLTimestamp{Time: dt}},
				{"sql_timestampadd_12", "TIMESTAMPADD(MINUTE, 60, DATE '2003-01-02')", evaluator.SQLTimestamp{Time: dt}},
				{"sql_timestampadd_13", "TIMESTAMPADD(MINUTE, 59.5, DATE '2003-01-02')", evaluator.SQLTimestamp{Time: dt}},
				{"sql_timestampadd_14", "TIMESTAMPADD(SECOND, 3600, DATE '2003-01-02')", evaluator.SQLTimestamp{Time: dt}},
				// No round test for SECOND, SECOND is not rounded.
				{"sql_timestampadd_15", "TIMESTAMPADD(MICROSECOND, 15000, TIMESTAMP '2003-01-02 12:30:09')", evaluator.SQLTimestamp{Time: t2}},
				{"sql_timestampadd_16", "TIMESTAMPADD(DAY, 1, TIMESTAMP '2003-01-01 12:30:09')", evaluator.SQLTimestamp{Time: t1}},
				{"sql_timestampadd_17", "TIMESTAMPADD(WEEK, 2, TIMESTAMP '2002-12-19 12:30:09')", evaluator.SQLTimestamp{Time: t1}},
				{"sql_timestampadd_18", "TIMESTAMPADD(SQL_TSI_YEAR, 2, TIMESTAMP '2001-01-02 12:30:09')", evaluator.SQLTimestamp{Time: t1}},
				{"sql_timestampadd_19", "TIMESTAMPADD(SQL_TSI_QUARTER, 2, DATE '2002-07-02')", evaluator.SQLTimestamp{Time: d}},
				{"sql_timestampadd_20", "TIMESTAMPADD(SQL_TSI_MONTH, 1, TIMESTAMP '2002-12-02 12:30:09')", evaluator.SQLTimestamp{Time: t1}},
				{"sql_timestampadd_21", "TIMESTAMPADD(SQL_TSI_WEEK, 1, DATE '2002-12-26')", evaluator.SQLTimestamp{Time: d}},
				{"sql_timestampadd_22", "TIMESTAMPADD(SQL_TSI_DAY, 1, DATE '2003-01-01')", evaluator.SQLTimestamp{Time: d}},
				{"sql_timestampadd_23", "TIMESTAMPADD(SQL_TSI_HOUR, 1, TIMESTAMP '2003-01-02 11:30:09')", evaluator.SQLTimestamp{Time: t1}},
				{"sql_timestampadd_24", "TIMESTAMPADD(SQL_TSI_MINUTE, 1, TIMESTAMP '2003-01-02 12:29:09')", evaluator.SQLTimestamp{Time: t1}},
				{"sql_timestampadd_25", "TIMESTAMPADD(SQL_TSI_SECOND, 1, TIMESTAMP '2003-01-02 12:30:08')", evaluator.SQLTimestamp{Time: t1}},
			}
			runTests(t, evalCtx, tests)
		})
		...
		t.Run("subject: sqlsubquerycmpexpr", func(t *testing.T) {
			t.Run("should not evaluate if the subquery returns a different number of columns than the left expression", func(t *testing.T) {
		...
		t.Run("subject: sqltupleexpr", func(t *testing.T) {
			t.Run("should evaluate all the expressions and return sqlvalues", func(t *testing.T) {
				...
				result, err := subject.Evaluate(evalCtx)
				req.Nil(err, "unable to evaluate sql expression")
				req.IsType(&evaluator.SQLValues{}, result, "expected type did not match actual type of evaluated expression")
				resultValues := result.(*evaluator.SQLValues)
				req.Equal(resultValues.Values[0], evaluator.SQLInt(10), "expected value did not match evaluated value of sql expr")
				req.Equal(resultValues.Values[1], evaluator.SQLInt(42), "expected value did not match evaluated value of sql expr")
			})
			t.Run("should evaluate to a single sqlvalue if it contains only one value", func(t *testing.T) {
				...
				req.Equal(intResult, evaluator.SQLInt(10), "expected value did not match evaluated value of sql expr")
				...
				req.Equal(varcharResult, evaluator.SQLVarchar("10"), "expected value did not match evaluated value of sql expr")
			})
		})
