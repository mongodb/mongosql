	...
	Convey("Subject: Evaluates", t, func() {
		...
		Convey("Subject: SQLAddExpr", func() {
			tests := []test{
				...
				test{"-10 + -32", SQLInt(-42)},
				test{"true + true", SQLFloat(2)},
				test{"true + true + false", SQLFloat(2)},
				test{"false + true + true", SQLFloat(2)},
				test{"true - '-1'", SQLFloat(2)},
				test{"true + '0'", SQLFloat(1)},
			}
		...
		Convey("Subject: SQLNullSafeEqualsExpr", func() {
			tests := []test{
				...
				test{"-10 <=> -10", SQLTrue},
				test{"1 <=> 1", SQLTrue},
				test{"NULL <=> NULL", SQLTrue},
				test{"1 <=> NULL", SQLFalse},
				test{"NULL <=> 1", SQLFalse},
			}
		...
		Convey("Subject: SQLScalarFunctionExpr", func() {
			...
			Convey("Subject: ADDDATE", func() {
				...
				tests := []test{
					...
					test{"ADDDATE('2003-01-01', INTERVAL 1 DAY)", SQLDate{Time: d}},
					test{"ADDDATE('2003-01-02 14:30:09', INTERVAL -2 HOUR)", SQLTimestamp{Time: t}},
					test{"ADDDATE('2003-01-02 12:23:09', INTERVAL 7 MINUTE)", SQLTimestamp{Time: t}},
					test{"ADDDATE('2003-01-02 12:30:12', INTERVAL -3 SECOND)", SQLTimestamp{Time: t}},
					test{"ADDDATE('2003-01-02 12:32:10', INTERVAL '-2:1' MINUTE_SECOND)", SQLTimestamp{Time: t}},
					test{"ADDDATE('2003-01-02 05:27:06', INTERVAL '7:3:3' HOUR_SECOND)", SQLTimestamp{Time: t}},
					test{"ADDDATE('2003-01-02 15:32:09', INTERVAL '-3:2' HOUR_MINUTE)", SQLTimestamp{Time: t}},
					test{"ADDDATE('2002-12-31 10:27:05', INTERVAL '2 2:3:4' DAY_SECOND)", SQLTimestamp{Time: t}},
					test{"ADDDATE('2002-12-31 10:27:09', INTERVAL '2 2:3' DAY_MINUTE)", SQLTimestamp{Time: t}},
					test{"ADDDATE('2003-01-01 08:30:09', INTERVAL '1 4' DAY_HOUR)", SQLTimestamp{Time: t}},
					test{"ADDDATE('2000-09-02 12:30:09', INTERVAL '2-4' YEAR_MONTH)", SQLTimestamp{Time: t}},
					test{"ADDDATE('2003-01-02 12:33:09', INTERVAL '-3' HOUR_MINUTE)", SQLTimestamp{Time: t}},
					test{"ADDDATE('2003-01-02 10:28:06', INTERVAL '2 2:3' DAY_SECOND)", SQLTimestamp{Time: t}},
					test{"ADDDATE('2003-01-02 10:28:06', 32)", SQLTimestamp{Time: t2}},
					test{"ADDDATE('2003-01-02 10:28:06', 43)", SQLTimestamp{Time: t3}},
					test{"ADDDATE('2003-01-02 10:28:06.000', 43)", SQLTimestamp{Time: t3}},
					test{"ADDDATE('2003-01-02 10:28:06.000000', 43)", SQLTimestamp{Time: t3}},
					test{"ADDDATE('2008-01-02', 31)", SQLDate{Time: d3}},
				}
				runTests(evalCtx, tests)
			})
			...
			Convey("Subject: CONVERT", func() {
				...
				tests := []test{
					test{"CONVERT(NULL, BINARY)", SQLNull},
					test{"CONVERT(NULL, BINARY(20))", SQLNull},
					test{"CONVERT(3, BINARY)", SQLNull},
					test{"CONVERT(3, BINARY(20))", SQLNull},
					test{"CONVERT('asgg', BINARY)", SQLNull},
					test{"CONVERT('asgg', BINARY(20))", SQLNull},
					...
					test{"CONVERT(NULL, DECIMAL)", SQLNull},
					test{"CONVERT(NULL, DECIMAL(12))", SQLNull},
					test{"CONVERT(NULL, DECIMAL(12,25))", SQLNull},
					...
					test{"CONVERT(NULL, CHAR(3))", SQLNull},
					test{"CONVERT(3, CHAR)", SQLVarchar("3")},
					test{"CONVERT(3, CHAR(4))", SQLVarchar("3")},
					test{"CONVERT(-3.4, SQL_VARCHAR)", SQLVarchar("-3.4")},
					test{"CONVERT('janna', CHAR)", SQLVarchar("janna")},
					test{"CONVERT('janna', CHAR(12))", SQLVarchar("janna")},
					test{"CONVERT('16a', CHAR)", SQLVarchar("16a")},
					test{"CONVERT('16a', CHAR(20))", SQLVarchar("16a")},
					test{"CONVERT(true, CHAR)", SQLVarchar("1")},
					test{"CONVERT(true, CHAR(20))", SQLVarchar("1")},
					test{"CONVERT(false, CHAR)", SQLVarchar("0")},
					test{"CONVERT(false, CHAR(20))", SQLVarchar("0")},
					test{"CONVERT(DATE '2006-05-11', CHAR)", SQLVarchar("2006-05-11")},
					test{"CONVERT(DATE '2006-05-11', CHAR(20))", SQLVarchar("2006-05-11")},
					test{"CONVERT(TIMESTAMP '2006-05-11 12:32:12', CHAR)", SQLVarchar("2006-05-11 12:32:12")},
					test{"CONVERT(TIMESTAMP '2006-05-11 12:32:12', CHAR(20))", SQLVarchar("2006-05-11 12:32:12")},
					test{"CONVERT(TIMESTAMP '2006-05-11 12:32:12', NCHAR)", SQLVarchar("2006-05-11 12:32:12")},
					test{"CONVERT(TIMESTAMP '2006-05-11 12:32:12', NCHAR(20))", SQLVarchar("2006-05-11 12:32:12")},
			...
			Convey("Subject: DATE", func() {
				...
				tests := []test{
					...
					test{"DATE(6911)", SQLNull},
					test{"DATE(2017110722040)", SQLNull},
					test{"DATE(-50)", SQLNull},
					test{"DATE('')", SQLNull},
					...
					test{"DATE(1)", SQLNull},
					test{"DATE(11)", SQLNull},

					// number inputs requiring padding
					test{"DATE(111)", SQLDate{Time: jan112000}},
					test{"DATE(1110)", SQLDate{Time: nov102000}},
					test{"DATE(61110)", SQLDate{Time: nov102006}},
					test{"DATE(1161110)", SQLDate{Time: nov100116}},
					test{"DATE(504123025)", SQLDate{Time: may042000}},
					test{"DATE(1110123025)", SQLDate{Time: nov102000}},
					test{"DATE(61110123025)", SQLDate{Time: nov102006}},
					test{"DATE(61110123025.22)", SQLDate{Time: nov102006}},
					test{"DATE(1161110123025)", SQLDate{Time: nov100116}},
					...
					test{"DATE('69-12-31')", SQLDate{Time: preCutoff}},
					test{"DATE('70-01-01')", SQLDate{Time: postCutoff}},
				}
				runTests(evalCtx, tests)
			})
			...
			Convey("Subject: DATE_SUB, SUBDATE", func() {
				...
				tests := []test{
					...
					test{"SUBDATE('2004-01-02', INTERVAL 1 YEAR)", SQLDate{Time: d}},
					test{"SUBDATE('2003-04-02', INTERVAL 1 QUARTER)", SQLDate{Time: d}},
					test{"SUBDATE('2003-12-31', INTERVAL 1 MONTH)", SQLDate{Time: d2}},
					test{"SUBDATE('2008-01-02 12:00:00', 31)", SQLTimestamp{Time: t2}},
					test{"SUBDATE('2016-01-02 12:00:00', 2953)", SQLTimestamp{Time: t2}},
			...
			Convey("Subject: FROM_DAYS", func() {
				...
				tests := []test{
					...
					test{"FROM_DAYS('sdg')", SQLVarchar("0000-00-00")},
					test{"FROM_DAYS(1.23)", SQLVarchar("0000-00-00")},
					test{"FROM_DAYS(-1.23)", SQLVarchar("0000-00-00")},
			...
			Convey("Subject: LAST_DAY", func() {
				...
				tests := []test{
					test{"LAST_DAY('')", SQLNull},
					test{"LAST_DAY(NULL)", SQLNull},
					test{"LAST_DAY('2003-03-32')", SQLNull},
					test{"LAST_DAY('2003-02-05')", SQLDate{d1}},
					test{"LAST_DAY('2004-02-05')", SQLDate{d2}},
					test{"LAST_DAY('2004-01-01 01:01:01')", SQLDate{d3}},
				}
				runTests(evalCtx, tests)
			})
			...
			Convey("Subject: REVERSE", func() {
				tests := []test{
					test{"REVERSE(NULL)", SQLNull},
					test{"REVERSE(3.14159265)", SQLVarchar("56295141.3")},
					test{"REVERSE(655)", SQLVarchar("556")},
					test{"REVERSE('www.mysql.com')", SQLVarchar("moc.lqsym.www")},
				}
				runTests(evalCtx, tests)
			})
			...
			Convey("Subject: LPAD", func() {
				tests := []test{
					...
					// basic case
					test{"LPAD('hello', 7, 'x')", SQLVarchar("xxhello")},

					// nulls in various positions
					test{"LPAD(NULL, 5, 'a')", SQLNull},
					test{"LPAD('hi', NULL, 'a')", SQLNull},
					test{"LPAD('hi', 5, NULL)", SQLNull},
					test{"LPAD(NULL, NULL, NULL)", SQLNull},

					// str: empty
					test{"LPAD('', 0, 'a')", SQLVarchar("")},
					test{"LPAD('', 1, 'a')", SQLVarchar("a")},
					test{"LPAD('', 7, 'ab')", SQLVarchar("abababa")},
					...
					test{"LPAD(10, 4, 'a')", SQLVarchar("aa10")},
					test{"LPAD(10.2, 4, 'a')", SQLVarchar("10.2")},

					// str type: boolean
					test{"LPAD(true, 4, 'a')", SQLVarchar("aaa1")},
					test{"LPAD(false, 4, 'a')", SQLVarchar("aaa0")},

					// len < 0
					test{"LPAD('hi', -1, 'a')", SQLNull},

					// len = 0
					test{"LPAD('hi', 0, 'a')", SQLVarchar("")},

					// len <= len(str)
					test{"LPAD('hello', 2, 'x')", SQLVarchar("he")},
					test{"LPAD('hello', 5, 'x')", SQLVarchar("hello")},

					// len type: str
					test{"LPAD('hello', '5', 'x')", SQLVarchar("hello")},
					test{"LPAD('hello', '5.6', 'x')", SQLVarchar("hello")},
					test{"LPAD('hello', '6', 'x')", SQLVarchar("xhello")},
					test{"LPAD('hello', '6.2', 'x')", SQLVarchar("xhello")},
					// if can't be cast to #, then use length 0
					test{"LPAD('hello', 'a', 'x')", SQLVarchar("")},

					// len: floating point
					test{"LPAD('hello', 5.4, 'x')", SQLVarchar("hello")},
					test{"LPAD('hello', 5.5, 'x')", SQLVarchar("xhello")},

					// len float values close to 0 - round to closest int
					test{"LPAD('hello', 0.4, 'x')", SQLVarchar("")},
					test{"LPAD('hello', 0.5, 'x')", SQLVarchar("h")},
					test{"LPAD('hello', -0.4, 'x')", SQLVarchar("")},
					test{"LPAD('hello', -0.5, 'x')", SQLNull},

					// len string values close to 0 - always round toward 0
					test{"LPAD('hello', '0.4', 'x')", SQLVarchar("")},
					test{"LPAD('hello', '0.5', 'x')", SQLVarchar("")},
					test{"LPAD('hello', '-0.4', 'x')", SQLVarchar("")},
					test{"LPAD('hello', '-0.5', 'x')", SQLVarchar("")},

					// len: bool
					test{"LPAD('hello', true, 'x')", SQLVarchar("h")},
					test{"LPAD('hello', false, 'x')", SQLVarchar("")},

					// len(padStr) > 1
					test{"LPAD('hello', 7, 'xy')", SQLVarchar("xyhello")},
					test{"LPAD('hello', 8, 'xy')", SQLVarchar("xyxhello")},

					// padStr type: number
					test{"LPAD('hello', 7, 1)", SQLVarchar("11hello")},
					test{"LPAD('hello', 10, 1.1)", SQLVarchar("1.11.hello")},
					test{"LPAD('hello', 10, -1)", SQLVarchar("-1-1-hello")},
			...
			Convey("Subject: SIGN", func() {
				tests := []test{
					...
					test{"SIGN(42)", SQLInt(1)},
					test{"SIGN(42.0)", SQLInt(1)},
					test{"SIGN(-42.0)", SQLInt(-1)},
					test{"SIGN('hello world')", SQLInt(0)},
				}
				runTests(evalCtx, tests)
			})
			...
			Convey("Subject: SUBSTRING", func() {
				tests := []test{
					...
					test{"SUBSTR('five', 2, 2)", SQLVarchar("iv")},
					test{"SUBSTR('nine', 4, 9)", SQLVarchar("e")},
					...
					test{"SUBSTRING(NULL from 4)", SQLNull},
					test{"SUBSTRING('foobarbar' from NULL)", SQLNull},
					test{"SUBSTRING('foobarbar' from 4 for NULL)", SQLNull},
					test{"SUBSTRING('Quadratically' FROM 5)", SQLVarchar("ratically")},
					test{"SUBSTRING('Quadratically' FROM  5 for 6)", SQLVarchar("ratica")},
					test{"SUBSTRING('Quadratically' from 12 FOR 2)", SQLVarchar("ly")},
					test{"SUBSTRING('Sakila' FROM -3)", SQLVarchar("ila")},
					test{"SUBSTRING('Sakila' from -5 for 3)", SQLVarchar("aki")},
					test{"SUBSTRING('日本語' FROM  2)", SQLVarchar("本語")},
					test{"SUBSTR(NULL FROM 4)", SQLNull},
					test{"SUBSTR('foobarbar' FROM NULL)", SQLNull},
					test{"SUBSTR('foobarbar' FROM 4 FOR NULL)", SQLNull},
					test{"SUBSTR('Quadratically' FROM  5)", SQLVarchar("ratically")},
					test{"SUBSTR('Quadratically' FROM  5 for 6)", SQLVarchar("ratica")},
					test{"SUBSTR('Sakila' from -3)", SQLVarchar("ila")},
					test{"SUBSTR('Sakila' from -5 for 3)", SQLVarchar("aki")},
					test{"SUBSTR('日本語' from 2)", SQLVarchar("本語")},
					test{"SUBSTR('five' from 2 for 2)", SQLVarchar("iv")},
					test{"SUBSTR('nine' from 4 for  9)", SQLVarchar("e")},
					test{"SUBSTR('five' FROM 4 FOR 3)", SQLVarchar("e")},
					test{"SUBSTR('five' FROM -1 FOR  1)", SQLVarchar("e")},
					test{"SUBSTR('five' FROM 4 FOR  0)", SQLVarchar("")},
					test{"SUBSTR('ZBA' FROM 0)", SQLVarchar("")},
					test{"SUBSTR('ZBA' FROM 0 FOR  1)", SQLVarchar("")},
					test{"SUBSTR('ZBA' FROM 0 for  -1)", SQLVarchar("")},
		...
		Convey("Subject: SQLVariableExpr", func() {
			tests := []test{
				test{"@@autocommit", SQLTrue},
				test{"@@global.autocommit", SQLTrue},
			}
	...
	Convey("Subject: NewSQLValue", t, func() {
		...
		Convey("Subject: SQLBoolean", func() {
			tests := []test{
				...
				test{floatVal, schema.SQLBoolean, SQLBool(floatVal)},
				test{0.0, schema.SQLBoolean, SQLFalse},
				test{objectIDVal, schema.SQLBoolean, SQLTrue},
				test{intVal, schema.SQLBoolean, SQLBool(intVal)},
				test{0, schema.SQLBoolean, SQLFalse},
				test{strFloatVal, schema.SQLBoolean, SQLBool(3.23)},
...
func TestTranslateExpr(t *testing.T) {
	...
	Convey("Subject: TranslateExpr", t, func() {
		...
		tests := []test{
			...
			test{"abs(a)", `{"$abs":"$a"}`},
			test{"adddate(g, INTERVAL 10 day)", `{"$let":{"in":{"$cond":[{"$eq":[{"$ifNull":["$$date",null]},null]},null,{"$add":["$$date",864000000]}]},"vars":{"date":"$g"}}}`},
			test{"adddate(g, null)", `{"$literal":null}`},
			test{"adddate(date_format(g, '%Y-01-01'), interval 0 second)", `{"$cond":[{"$eq":[{"$ifNull":["$g",null]},null]},null,{"$subtract":["$g",{"$add":[{"$multiply":[{"$subtract":[{"$dayOfYear":"$g"},1]},86400000]},{"$multiply":[{"$hour":"$g"},3600000]},{"$multiply":[{"$minute":"$g"},60000]},{"$multiply":[{"$second":"$g"},1000]},{"$millisecond":"$g"}]}]}]}`},
			test{"adddate(date_format(g, '%Y-01-01 00:00:00'), interval 0 second)", `{"$cond":[{"$eq":[{"$ifNull":["$g",null]},null]},null,{"$subtract":["$g",{"$add":[{"$multiply":[{"$subtract":[{"$dayOfYear":"$g"},1]},86400000]},{"$multiply":[{"$hour":"$g"},3600000]},{"$multiply":[{"$minute":"$g"},60000]},{"$multiply":[{"$second":"$g"},1000]},{"$millisecond":"$g"}]}]}]}`},
			test{"adddate(date_format(g, '%Y-%m-01'), interval 0 second)", `{"$cond":[{"$eq":[{"$ifNull":["$g",null]},null]},null,{"$subtract":["$g",{"$add":[{"$multiply":[{"$subtract":[{"$dayOfMonth":"$g"},1]},86400000]},{"$multiply":[{"$hour":"$g"},3600000]},{"$multiply":[{"$minute":"$g"},60000]},{"$multiply":[{"$second":"$g"},1000]},{"$millisecond":"$g"}]}]}]}`},
			test{"adddate(date_format(g, '%Y-%m-01 00:00:00'), interval 0 second)", `{"$cond":[{"$eq":[{"$ifNull":["$g",null]},null]},null,{"$subtract":["$g",{"$add":[{"$multiply":[{"$subtract":[{"$dayOfMonth":"$g"},1]},86400000]},{"$multiply":[{"$hour":"$g"},3600000]},{"$multiply":[{"$minute":"$g"},60000]},{"$multiply":[{"$second":"$g"},1000]},{"$millisecond":"$g"}]}]}]}`},
			test{"adddate(date_format(g, '%Y-%m-%d'), interval 0 second)", `{"$cond":[{"$eq":[{"$ifNull":["$g",null]},null]},null,{"$subtract":["$g",{"$add":[{"$multiply":[{"$hour":"$g"},3600000]},{"$multiply":[{"$minute":"$g"},60000]},{"$multiply":[{"$second":"$g"},1000]},{"$millisecond":"$g"}]}]}]}`},
			test{"adddate(date_format(g, '%Y-%m-%d 00:00:00'), interval 0 second)", `{"$cond":[{"$eq":[{"$ifNull":["$g",null]},null]},null,{"$subtract":["$g",{"$add":[{"$multiply":[{"$hour":"$g"},3600000]},{"$multiply":[{"$minute":"$g"},60000]},{"$multiply":[{"$second":"$g"},1000]},{"$millisecond":"$g"}]}]}]}`},
			test{"adddate(date_format(g, '%Y-%m-%d %H:00:00'), interval 0 second)", `{"$cond":[{"$eq":[{"$ifNull":["$g",null]},null]},null,{"$subtract":["$g",{"$add":[{"$multiply":[{"$minute":"$g"},60000]},{"$multiply":[{"$second":"$g"},1000]},{"$millisecond":"$g"}]}]}]}`},
			test{"adddate(date_format(g, '%Y-%m-%d %H:%i:00'), interval 0 second)", `{"$cond":[{"$eq":[{"$ifNull":["$g",null]},null]},null,{"$subtract":["$g",{"$add":[{"$multiply":[{"$second":"$g"},1000]},{"$millisecond":"$g"}]}]}]}`},
			test{"adddate(date_format(g, '%Y-%m-%d %H:%i:%s'), interval 0 second)", `{"$cond":[{"$eq":[{"$ifNull":["$g",null]},null]},null,{"$subtract":["$g",{"$millisecond":"$g"}]}]}`},
			test{"adddate(date_format(g, '%Y-%m-%d %H:%i:%s'), interval 10 second)", `{"$let":{"in":{"$cond":[{"$eq":[{"$ifNull":["$$date",null]},null]},null,{"$add":["$$date",10000]}]},"vars":{"date":{"$cond":[{"$eq":[{"$ifNull":["$g",null]},null]},null,{"$subtract":["$g",{"$millisecond":"$g"}]}]}}}}`},
			test{"adddate(date_format(g, '%Y-%m-%d %H:%i:%s'), interval -10 minute)", `{"$let":{"in":{"$cond":[{"$eq":[{"$ifNull":["$$date",null]},null]},null,{"$add":["$$date",-600000]}]},"vars":{"date":{"$cond":[{"$eq":[{"$ifNull":["$g",null]},null]},null,{"$subtract":["$g",{"$millisecond":"$g"}]}]}}}}`},
			test{"ceil(a)", `{"$ceil":"$a"}`},
			...
			test{"date_add(g, INTERVAL 10 day)", `{"$let":{"in":{"$cond":[{"$eq":[{"$ifNull":["$$date",null]},null]},null,{"$add":["$$date",864000000]}]},"vars":{"date":"$g"}}}`},
			...
			test{"date_sub(g, INTERVAL 10 day)", `{"$let":{"in":{"$cond":[{"$eq":[{"$ifNull":["$$date",null]},null]},null,{"$add":["$$date",-864000000]}]},"vars":{"date":"$g"}}}`},
			...
			test{"subdate(g, INTERVAL 10 day)", `{"$let":{"in":{"$cond":[{"$eq":[{"$ifNull":["$$date",null]},null]},null,{"$add":["$$date",-864000000]}]},"vars":{"date":"$g"}}}`},
	...
	Convey("Subject: CompareTo", t, func() {
		...
		Convey("Subject: SQLUint32", func() {
			tests := []test{
				...
				{SQLUint32(1), SQLFalse, 1},
				{SQLUint32(1), SQLTrue, 0},
		...
		Convey("Subject: SQLUint64", func() {
			tests := []test{
				...
				{SQLUint64(1), SQLFalse, 1},
				{SQLUint64(1), SQLTrue, 0},
		...
		Convey("Subject: SQLFloat", func() {
			tests := []test{
				...
				{SQLFloat(0.1), SQLFalse, 1},
				{SQLFloat(0.1), SQLTrue, -1},
		...
		Convey("Subject: SQLBool", func() {
			tests := []test{
				...
				{SQLTrue, SQLInt(1), 0},
				{SQLTrue, SQLInt(2), -1},
				{SQLTrue, SQLUint32(1), 0},
				{SQLTrue, SQLFloat(1), 0},
				{SQLTrue, SQLFalse, 1},
				{SQLTrue, SQLTrue, 0},
				{SQLTrue, SQLNull, 1},
				{SQLTrue, SQLObjectID("56e0750e1d857aea925a4ba1"), 1},
				{SQLTrue, SQLVarchar("bac"), 1},
				{SQLTrue, &SQLValues{[]SQLValue{SQLInt(1)}}, 0},
				{SQLTrue, &SQLValues{[]SQLValue{SQLNone}}, 1},
				{SQLTrue, SQLDate{now}, -1},
				{SQLTrue, SQLTimestamp{now}, -1},
				{SQLFalse, SQLInt(0), 0},
				{SQLFalse, SQLInt(1), -1},
				{SQLFalse, SQLInt(2), -1},
				{SQLFalse, SQLUint32(1), -1},
				{SQLFalse, SQLFloat(1), -1},
				{SQLFalse, SQLFalse, 0},
				{SQLFalse, SQLTrue, -1},
				{SQLFalse, SQLNull, 1},
				{SQLFalse, SQLObjectID("56e0750e1d857aea925a4ba1"), 0},
				{SQLFalse, SQLVarchar("bac"), 0},
				{SQLFalse, &SQLValues{[]SQLValue{SQLInt(1)}}, -1},
				{SQLFalse, &SQLValues{[]SQLValue{SQLNone}}, 1},
				{SQLFalse, SQLDate{now}, -1},
				{SQLFalse, SQLTimestamp{now}, -1},
			}
			runTests(tests)
		})
		...
		Convey("Subject: SQLValues", func() {
			tests := []test{
				...
				{&SQLValues{[]SQLValue{SQLInt(1)}}, SQLFalse, 1},
		...
		Convey("Subject: SQLObjectID", func() {
			...
			tests := []test{
				...
				{SQLObjectID(oid2), SQLFalse, 0},
				{SQLObjectID(oid2), SQLTrue, -1},
