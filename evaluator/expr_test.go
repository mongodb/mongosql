...
func TestEvaluates(t *testing.T) {
	...
	t.Run("evaluates", func(t *testing.T) {
		...
		tests := []test{
			...
			{"sql_conv_0", "conv('12A', 13, 7)", evaluator.SQLVarchar("412")},
			{"sql_conv_1", "conv('345', 8, 10)", evaluator.SQLVarchar("229")},
			{"sql_conv_2", "conv('123.-/', 10, 6)", evaluator.SQLVarchar("323")},
			{"sql_conv_3", "conv('4A', 10, 2)", evaluator.SQLVarchar("0")},
			{"sql_conv_4", "conv('23-', 5, 3)", evaluator.SQLVarchar("0")},
			{"sql_conv_5", "conv('74', 48, 3)", evaluator.SQLNull},
			{"sql_conv_6", "conv('13', 1, 7)", evaluator.SQLNull},
			{"sql_conv_7", "conv('-34', 5, 11)", evaluator.SQLVarchar("-18")},
			{"sql_conv_8", "conv('-0', 5, 7)", evaluator.SQLVarchar("0")},
			...
			{"sql_scalar_atan_expr_6", "ATAN('C', 2)", evaluator.SQLFloat(0)},
			{"sql_scalar_atan_expr_7", "ATAN(0, 2)", evaluator.SQLFloat(0)},
