	...
	t.Run("evaluates", func(t *testing.T) {
		...
		t.Run("argument validation", func(t *testing.T) {
			...
			errTests := []errTest{
				...
				{"eq(string,string)", NewSQLComparisonExpr(EQ, strVal, strVal), true},
				{"eq(int,int)", NewSQLComparisonExpr(EQ, intVal, intVal), true},
				{"eq(bool,bool)", NewSQLComparisonExpr(EQ, boolVal, boolVal), true},
				{"eq(int,float)", NewSQLComparisonExpr(EQ, intVal, floatVal), true},
				{"eq(int,bool)", NewSQLComparisonExpr(EQ, intVal, boolVal), false},
				{"eq(int,string)", NewSQLComparisonExpr(EQ, intVal, strVal), false},
				{"eq(string,bool)", NewSQLComparisonExpr(EQ, strVal, boolVal), false},

				{"lt(string,string)", NewSQLComparisonExpr(LT, strVal, strVal), true},
				{"lt(int,int)", NewSQLComparisonExpr(LT, intVal, intVal), true},
				{"lt(bool,bool)", NewSQLComparisonExpr(LT, boolVal, boolVal), true},
				{"lt(int,float)", NewSQLComparisonExpr(LT, intVal, floatVal), true},
				{"lt(int,bool)", NewSQLComparisonExpr(LT, intVal, boolVal), false},
				{"lt(int,string)", NewSQLComparisonExpr(LT, intVal, strVal), false},
				{"lt(string,bool)", NewSQLComparisonExpr(LT, strVal, boolVal), false},

				{"lte(string,string)", NewSQLComparisonExpr(LTE, strVal, strVal), true},
				{"lte(int,int)", NewSQLComparisonExpr(LTE, intVal, intVal), true},
				{"lte(bool,bool)", NewSQLComparisonExpr(LTE, boolVal, boolVal), true},
				{"lte(int,float)", NewSQLComparisonExpr(LTE, intVal, floatVal), true},
				{"lte(int,bool)", NewSQLComparisonExpr(LTE, intVal, boolVal), false},
				{"lte(int,string)", NewSQLComparisonExpr(LTE, intVal, strVal), false},
				{"lte(string,bool)", NewSQLComparisonExpr(LTE, strVal, boolVal), false},

				{"neq(string,string)", NewSQLComparisonExpr(NEQ, strVal, strVal), true},
				{"neq(int,int)", NewSQLComparisonExpr(NEQ, intVal, intVal), true},
				{"neq(bool,bool)", NewSQLComparisonExpr(NEQ, boolVal, boolVal), true},
				{"neq(int,float)", NewSQLComparisonExpr(NEQ, intVal, floatVal), true},
				{"neq(int,bool)", NewSQLComparisonExpr(NEQ, intVal, boolVal), false},
				{"neq(int,string)", NewSQLComparisonExpr(NEQ, intVal, strVal), false},
				{"neq(string,bool)", NewSQLComparisonExpr(NEQ, strVal, boolVal), false},
