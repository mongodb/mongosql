...
func TestTranslate(t *testing.T) {
	...
	tests := []test{
		...
		{"scalar_from_unixtime_float", "from_unixtime(c)"},
		...
		{"scalar_from_days_float", "from_days(c)"},
		...
		{"scalar_insert_float", "insert(s,c,a,s)"},
		...
		{"scalar_locate_three_args_float", "locate(s, 'funny', c)"},
		{"scalar_log", "log(a)"},
		...
		{"scalar_repeat_float", "repeat(s, c)"},
