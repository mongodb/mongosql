...
use crate::internal_integration_tests::consts::{
    LARGE_PARTITIONS, NONUNIFORM_LARGE_PARTITION_SCHEMAS, NONUNIFORM_LARGE_SCHEMA,
    NONUNIFORM_SMALL_SCHEMA, NONUNIFORM_VIEW_SCHEMA, SMALL_PARTITIONS, UNIFORM_COLL_SCHEMA,
    UNIFORM_VIEW_SCHEMA,
};
use test_utils::schema_builder_library_integration_test_consts::{
    LARGE_COLL_NAME, NONUNIFORM_DB_NAME, SMALL_COLL_NAME, UNIFORM_DB_NAME, VIEW_NAME,
};
...
mod derive_schema_for_partitions {
    ...
    test_derive_schema_for_partitions!(
        derive_partitions_nonuniform_large,
        NONUNIFORM_DB_NAME,
        LARGE_COLL_NAME,
    ...
    test_derive_schema_for_partitions!(
        derive_partitions_nonuniform_small,
        NONUNIFORM_DB_NAME,
        SMALL_COLL_NAME,
    ...
    test_derive_schema_for_partitions!(
        derive_partitions_uniform_large,
        UNIFORM_DB_NAME,
        LARGE_COLL_NAME,
        *UNIFORM_COLL_SCHEMA,
        LARGE_PARTITIONS,
    ...
    test_derive_schema_for_partitions!(
        derive_partitions_uniform_small,
        UNIFORM_DB_NAME,
        SMALL_COLL_NAME,
        *UNIFORM_COLL_SCHEMA,
        SMALL_PARTITIONS,
...
mod derive_schema_for_partition {
    ...
    test_derive_schema_for_partition!(
        derive_partition_nonuniform_large,
        NONUNIFORM_DB_NAME,
        LARGE_COLL_NAME,
    ...
    test_derive_schema_for_partition!(
        derive_partition_nonuniform_small,
        NONUNIFORM_DB_NAME,
        SMALL_COLL_NAME,
    ...
    test_derive_schema_for_partition!(
        derive_partition_uniform_large,
        UNIFORM_DB_NAME,
        LARGE_COLL_NAME,
    ...
    test_derive_schema_for_partition!(
        derive_partition_uniform_small,
        UNIFORM_DB_NAME,
        SMALL_COLL_NAME,
