...
var mySQLErrName = map[uint16]string{
	...
	ErCantAggregateTwoCollations:               "Illegal mix of collations (%s,%s) and (%s,%s) for operation '%s'",
	...
	ErCantAggregateThreeCollations:             "Illegal mix of collations (%s,%s), (%s,%s), (%s,%s) for operation '%s'",
	...
	ErRowIsReferencedTwo:                       "Cannot delete or update a parent row: a foreign key constraint fails (%.192s)",
	ErNoReferencedRowTwo:                       "Cannot add or update a child row: a foreign key constraint fails (%.192s)",
	...
	ErSlaveIncident:                            "The incident %s occurred on the master. Message: %-.64s",
	...
	ErVariableIsReadonly:                                    "%s variable '%s' is read-only.",
	...
	ErGtidModeRequiresEnforcedCtidConsistencyOn:             "@@GLOBAL.GTID_MODE = ON or UPGRADE_STEP_2 requires @@GLOBAL.ENFORCE_GTID_CONSISTENCY = 1.",
