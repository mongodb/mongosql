...
lazy_static! {
    ...
    pub static ref NONUNIFORM_LARGE_SCHEMA: Arc<Schema> = Arc::new(Schema::Document(Document {
        keys: map!(
    ...
    pub static ref NONUNIFORM_SMALL_SCHEMA: Arc<Schema> = Arc::new(Schema::Document(Document {
        keys: map!(
            "_id".to_string() => Schema::Atomic(Atomic::Long),
            "padding".to_string() => Schema::Atomic(Atomic::String),
            "second".to_string() => Schema::AnyOf(set!(
    ...
    pub static ref NONUNIFORM_VIEW_SCHEMA: Arc<Schema> = Arc::new(Schema::Document(Document {
        keys: map! {
            "_id".to_string() => Schema::Atomic(Atomic::Long),
            "var".to_string() => Schema::AnyOf(set! {
                Schema::Atomic(Atomic::Integer),
    ...
    pub static ref UNIFORM_COLL_SCHEMA: Arc<Schema> = Arc::new(Schema::Document(Document {
        keys: map!(
            "_id".to_string() => Schema::Atomic(Atomic::Long),
    ...
    pub static ref UNIFORM_VIEW_SCHEMA: Arc<Schema> = Arc::new(Schema::Document(Document {
        keys: map! {
            "_id".to_string() => Schema::Atomic(Atomic::Long),
