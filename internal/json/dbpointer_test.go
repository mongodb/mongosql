	...
	Convey("Unmarshalling JSON with DBPointer values", t, func() {
		...
		Convey("works for a single key", func() {
			...
			So(
				jsonValue,
				ShouldResemble,
				DBPointer{"ref", bson.ObjectIdHex("552ffe9f5739878e73d116a9")},
			)
		})
		...
		Convey("works for multiple keys", func() {
			...
			So(
				jsonValue2,
				ShouldResemble,
				DBPointer{"ref2", bson.ObjectIdHex("552ffed95739878e73d116aa")},
			)
			...
			So(
				jsonValue3,
				ShouldResemble,
				DBPointer{"ref3", bson.ObjectIdHex("552fff215739878e73d116ab")},
			)
		})
