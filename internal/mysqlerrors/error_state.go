...
const (
	// DefaultMySQLState is the error state to be used with errors that aren't
	// associated with a particular state in the map below.
...
var mySQLState = map[uint16]string{
	...
	ErRowIsReferencedTwo:                  "23000",
	ErNoReferencedRowTwo:                  "23000",
