...
var (
	...
	ServerVersion = flag.String("serverVersion", "3.7", "The version of MongoDB against which "+
		"these tests are being run, used to decide which tests should be skipped based on "+
		"min_server_version")
